---
title: Virtualization in UWP DOCX Editor | Syncfusion
description: The virtualization in UWP DOCX Editor offers UI Virtualization support, enabling UI elements to be created only for visible content, reducing memory use.
