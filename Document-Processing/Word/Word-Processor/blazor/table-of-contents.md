...
[Blazor Document Editor](https://www.syncfusion.com/docx-editor-sdk/blazor-docx-editor) exposes an API to insert table of contents at cursor position programmatically. The settings for a table of contents can be specified explicitly. Otherwise, the default settings will be applied.
