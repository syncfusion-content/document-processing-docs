...
Document Editor provides an option to enable Async (Lazy) Loading using the [`OpenAsyncSettings`](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.DocumentEditor.OpenAsyncSettingsModel.html) property.
