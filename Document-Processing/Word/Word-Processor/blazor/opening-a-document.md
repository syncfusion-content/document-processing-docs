...
If you have your Word document file in the web, you can open it in [Blazor DOCX Editor ](https://www.syncfusion.com/docx-editor-sdk/blazor-docx-editor) using URL. The following code example explains how to open a Word document file from URL.
