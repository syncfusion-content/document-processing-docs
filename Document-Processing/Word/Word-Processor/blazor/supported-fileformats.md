...
description: Learn about the file formats supported by Blazor DOCX Editor.
...
Syncfusion<sup style="font-size:70%">&reg;</sup> Blazor DOCX Editor (Document Editor) supports a wide range of Microsoft Word and other document formats for opening and exporting, with both client-side and server-side capabilities.
