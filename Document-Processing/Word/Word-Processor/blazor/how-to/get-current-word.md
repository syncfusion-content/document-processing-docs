...
The [Blazor DOCX Editor ](https://www.syncfusion.com/docx-editor-sdk/blazor-docx-editor) component allows for getting the current word or paragraph content as plain text and SFDT (rich text).
