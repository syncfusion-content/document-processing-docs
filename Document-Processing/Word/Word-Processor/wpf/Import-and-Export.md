...
## Loading and saving asynchronously

The following code example demonstrates how to load a document asynchronously using the [LoadAsync](https://help.syncfusion.com/cr/wpf/Syncfusion.Windows.Controls.RichTextBoxAdv.SfRichTextBoxAdv.html#Syncfusion_Windows_Controls_RichTextBoxAdv_SfRichTextBoxAdv_LoadAsync_System_String_) method. To save a document asynchronously, use the [SaveAsync](https://help.syncfusion.com/cr/wpf/Syncfusion.Windows.Controls.RichTextBoxAdv.SfRichTextBoxAdv.html#Syncfusion_Windows_Controls_RichTextBoxAdv_SfRichTextBoxAdv_SaveAsync_System_String_) method with the same overloads.
