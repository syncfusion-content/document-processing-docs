...
The following are needed to enable collaborative editing in [Vue Document Editor](https://www.syncfusion.com/docx-editor-sdk/vue-docx-editor).
...
Configure the Redis that stores temporary data for the collaborative editing session. Provide the Redis connection string in `app settings.json` file.
