---
layout: post
title: Open document from One Drive in Vue Document editor | Syncfusion
...
To load a document from One Drive in a [Vue Document Editor](https://www.syncfusion.com/docx-editor-sdk/vue-docx-editor), you can follow the steps below
