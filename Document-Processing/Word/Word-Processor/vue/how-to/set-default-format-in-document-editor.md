...
You can set the default character format, paragraph format and section format in [Vue Document Editor](https://www.syncfusion.com/docx-editor-sdk/vue-docx-editor).
