...
By default, [Vue Document Editor](https://www.syncfusion.com/docx-editor-sdk/vue-docx-editor) will open blank document. You can use [`open`](https://ej2.syncfusion.com/vue/documentation/api/document-editor#open) API in Document Editor to open the sfdt content.
