...
To print the document, use the [`print`](https://ej2.syncfusion.com/vue/documentation/api/document-editor#print) method from [Vue Document Editor](https://www.syncfusion.com/docx-editor-sdk/vue-docx-editor) instance.
