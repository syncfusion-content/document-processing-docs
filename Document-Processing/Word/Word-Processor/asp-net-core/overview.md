...
# Overview of the Syncfusion<sup>&reg;</sup> ASP.NET Core DOCX Editor
...
* Supports formats like [text](../asp-net-core/text-format), [paragraph](../asp-net-core/paragraph-format), [bullets and numbering](../asp-net-core/list-format), [table](../asp-net-core/table-format) and [page settings](../asp-net-core/section-format).
