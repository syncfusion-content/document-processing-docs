...
The [ASP.NET Core Document Editor](https://www.syncfusion.com/docx-editor-sdk/asp-net-core-docx-editor) provides an extensive and flexible API to customize the built-in ribbon UI. You can:
