...
The following table lists the default keyboard shortcuts in [ASP.NET Core Document Editor](https://www.syncfusion.com/docx-editor-sdk/asp-net-core-docx-editor) (Document Editor) for formatting text:
...
* [How to override the keyboard shortcuts](../asp-net-core/how-to/override-the-keyboard-shortcuts).
