...
To load document from Azure Blob Storage in a [ASP.NET Core Document Editor](https://www.syncfusion.com/docx-editor-sdk/asp-net-core-docx-editor), you can follow the steps below
