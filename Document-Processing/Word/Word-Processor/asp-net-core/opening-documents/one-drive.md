...
To load a document from One Drive in a [ASP.NET Core Document Editor](https://www.syncfusion.com/docx-editor-sdk/asp-net-core-docx-editor), you can follow the steps below
