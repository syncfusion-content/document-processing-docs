...
To load a document from Box cloud file storage in a [ASP.NET Core Document Editor](https://www.syncfusion.com/docx-editor-sdk/asp-net-core-docx-editor), you can follow the steps below
