...
- [Syncfusion Collaborator](https://help.syncfusion.com/document-processing/collaborator/overview) client and server packages:
...
The browser side uses the shared [Collaboration Client](https://help.syncfusion.com/document-processing/collaborator/collaboration-client) (`@syncfusion/ej2-collaborator`) wired to the ASP.NET Core DOCX Editor through a control-specific **adapter** that implements the `ICollaborationProvider` interface.
...
Create an ASP.NET Core web service to handle server-side operations. Refer to the [ASP.NET Core web service for ASP.NET Core DOCX Editor](https://help.syncfusion.com/document-processing/word/word-processor/javascript-es6/web-services/core) documentation to create the web service project.
