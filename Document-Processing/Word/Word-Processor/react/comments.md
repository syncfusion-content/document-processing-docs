...
DOCX Editor allows you to get the comments along with their replies and comment properties using [`getComments`](https://ej2.syncfusion.com/react/documentation/api/document-editor#getcomments).
...
Current comment can be deleted using [`deleteComment`](https://ej2.syncfusion.com/react/documentation/api/document-editor/editor#deletecomment).
...
By enable 'highlightCommentsByAuthor' as true each comment marker and pane border is displayed in the author’s avatar color. 
When a comment is selected, the corresponding text is highlighted in that color. 
If multiple comments occur on the same line, the marker retains the first author’s avatar color.
...
Explore how to add, view, and manage comments in Word documents using the React DOCX Editor in this live demo [here](https://document.syncfusion.com/demos/docx-editor/react/#/tailwind3/document-editor/comments).
