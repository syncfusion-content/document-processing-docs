...
1. Create a web service project in .NET Core 3.0 or above. You can refer to this [link](../../document-editor/web-services) for instructions on how to create a web service project.
