...
description: Disable optimized text measuring in Syncfusion® React DOCX Editor to retain document pagination behavior and maintain layout consistency.
...
# How to Disable Optimized Text Measuring in React DOCX Editor
...
If you want the DOCX Editor component to retain the document pagination (display page-by-page) behavior like v19.2.0.x and older versions, then you can disable this optimized text measuring improvement, by setting `false` to [`enableOptimizedTextMeasuring`](https://ej2.syncfusion.com/react/documentation/api/document-editor/documentEditorSettingsModel#enableoptimizedtextmeasuring) property of React DOCX Editor component.
