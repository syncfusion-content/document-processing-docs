---
layout: post
title: How to Export Document as PDF in React DOCX Editor | Syncfusion
description: Export documents as PDF in Syncfusion® React DOCX Editor using client-side and server-side export options for flexible document sharing.
