...
The [React Document Editor](https://www.syncfusion.com/docx-editor-sdk/react-docx-editor) provides an extensive and flexible API to customize the built-in ribbon UI. You can:
