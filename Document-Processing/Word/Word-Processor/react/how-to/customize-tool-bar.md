---
layout: post
title: How to Customize Toolbar in React DOCX Editor | Syncfusion
description: Customize the toolbar in Syncfusion® React DOCX Editor by adding, removing, showing, hiding, enabling, and disabling toolbar items.
