---
layout: post
title: Tables in React DOCX Editor | Syncfusion
description: Tables in React DOCX Editor enable adding and managing rows, columns, and cells to present information in a structured format.
control: Table 
