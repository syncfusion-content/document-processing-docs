---
layout: post
title: Bookmarks in React DOCX Editor | Syncfusion
description: The bookmark feature in React DOCX Editor lets users add, manage, and navigate bookmarks for quick access to specific document sections.
control: Bookmark
...
# Bookmarks in React DOCX Editor
...
You can select a bookmark by its name using the [`selectBookmark`](https://ej2.syncfusion.com/react/documentation/api/document-editor/selection#selectbookmark) method, which also navigates the editor to the bookmark location, as shown in the following code snippet.
