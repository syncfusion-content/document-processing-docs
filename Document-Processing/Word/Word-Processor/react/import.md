...
In [React Document Editor](https://www.syncfusion.com/docx-editor-sdk/react-docx-editor), the documents are stored in its own format called **Syncfusion Document Text (SFDT)**.
