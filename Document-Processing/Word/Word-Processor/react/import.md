...
Document Editor provides an option to enable Async (Lazy) Loading using the [`openAsyncSettings`](https://ej2.syncfusion.com/react/documentation/api/document-editor/openasyncsettings) property.
