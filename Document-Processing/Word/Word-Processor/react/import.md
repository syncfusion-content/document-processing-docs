---
layout: post
title: Import in React DOCX Editor | Syncfusion
description: The Import feature in React DOCX Editor enables users to load and edit documents from supported formats while preserving content structure.
control: Import 
...
# Import in React DOCX Editor

In [React DOCX Editor](https://www.syncfusion.com/docx-editor-sdk/react-docx-editor) (Document Editor), the documents are stored in DOCX Editor's own format called **Syncfusion Document Text (SFDT)**.
