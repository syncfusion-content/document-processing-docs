...
description: Learn how to save a document to Dropbox cloud file storage in the Syncfusion React DOCX Editor of Syncfusion Essential JS 2 and more details.
...
public DocumentEditorController(IConfiguration configuration)
{
