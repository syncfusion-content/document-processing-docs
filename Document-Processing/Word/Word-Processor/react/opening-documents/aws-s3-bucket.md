---
layout: post
title: Open Documents from AWS S3 in React DOCX Editor | Syncfusion
description: Open documents from AWS S3 in React DOCX Editor, enabling cloud storage integration and seamless document access.
...
# Open Documents from AWS S3 in React DOCX Editor

To load a document from AWS S3 in a [React Document Editor](https://www.syncfusion.com/docx-editor-sdk/react-docx-editor) (Document Editor), you can follow the steps below.
