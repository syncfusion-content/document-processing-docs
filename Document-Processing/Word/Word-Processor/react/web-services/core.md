---
layout: post
title: ASP.NET Core Web Service in React DOCX Editor | Syncfusion
description: Configure ASP.NET Core web services in the React DOCX Editor to handle server-side operations such as Word document import, export, spell checking, and more.
control: Core 
