...
# Collaborative Editing in ASP.NET MVC with Redis in ASP.NET Core
...
N> For better performance, a minimum `SaveThreshold` value of 100 is recommended.
...
{% include code-snippet/document-editor/asp-net-mvc/collaborative-editing/razor %}
{% endhighlight %}
{% highlight c# tabtitle="Document-editor.cs" %}
{% include code-snippet/document-editor/asp-net-mvc/collaborative-editing/document-editor.cs %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/document-editor/asp-net-mvc/collaborative-editing/script-1 %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/document-editor/asp-net-mvc/collaborative-editing/script-2 %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight razor tabtitle="CSHTML" %}
{% include code-snippet/document-editor/asp-net-mvc/collaborative-editing/script-3 %}
{% endhighlight %}
{% endtabs %}
...
### Step 2: Configure SignalR hub to create a room for the collaborative editing session
...
static Dictionary<string, ActionInfo> userManager = new Dictionary<string, ActionInfo>();
    ...
    public async Task JoinGroup(ActionInfo info)
    {
        ...
        //Add the current connected user to the specified group
       ...
       // Notify other users in the group about a new user joined the collaborative editing session.
...
//If all users disconnected from the current room. Auto save the changes to the source document.
CollaborativeEditingController.UpdateOperationsToSourceDocument(roomName, "<<documentpath>>", false);
        ...
        if (userManager.ContainsKey(Context.ConnectionId))
        {
            //Notify other users in the group about the user exiting the collaborative editing session
...
### Step 3: Configure the Redis cache connection string at the application level

Configure the Redis that stores temporary data for the collaborative editing session. Provide the Redis connection string in the `appsettings.json` file.
