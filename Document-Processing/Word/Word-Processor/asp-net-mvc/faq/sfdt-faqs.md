...
description: Find frequently asked questions about SFDT format in the ASP.NET MVC DOCX Editor control, including its structure and usage.
control: SFDT format
...
The frequently asked questions about SFDT in DOCX Editor are listed below:
...
Yes. You can easily convert SFDT back to DOCX or other [supported formats](../supported-fileformats) in the DOCX Editor.
