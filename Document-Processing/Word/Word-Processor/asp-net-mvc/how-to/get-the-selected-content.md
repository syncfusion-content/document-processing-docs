...
# How to get the selected content in ASP.NET MVC Document Editor
...
You can use the `text` API to get the selected content as plain text from the ASP.NET MVC Document Editor component.
...
You can use the `sfdt` API to get the selected content as rich text from the ASP.NET MVC Document Editor component.
