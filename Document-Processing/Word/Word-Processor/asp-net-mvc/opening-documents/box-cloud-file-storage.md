---
layout: post
title: Opening the document from Box cloud file storage in Syncfusion ASP.NET MVC Document editor control | Syncfusion
...
# Open document from Box cloud file storage in ASP.NET MVC Document editor
