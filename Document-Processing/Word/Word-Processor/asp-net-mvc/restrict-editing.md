...
description: Learn how to enable Restrict Editing in the ASP.NET MVC DOCX Editor to securely manage document access and control user modifications.
...
Syncfusion® ASP.NET MVC DOCX Editor (Document Editor) provides support for restricting editing within a document. It enables control over how and where content can be modified. This helps limit editing so only specific sections of the document can be changed.
...
@Html.EJS().DocumentEditor("container")
    .Height("600px")
    .EnableToolbar(true)
...
<script>
    ...
    // Enforce Restrict Editing
    function enforceProtection() {
        documenteditor.editor.enforceProtection('123', 'ReadOnly');
    }

    // Stop Restrict Editing
...
- [Web Service for Restrict editing in ASP.NET Core](https://help.syncfusion.com/document-processing/word/word-processor/asp-net-mvc/restrict-editing)

- [Web Service for Restrict editing in ASP.NET MVC](https://help.syncfusion.com/document-processing/word/word-processor/asp-net-mvc/restrict-editing)

- [Web Service for Restrict editing in Java](https://help.syncfusion.com/document-processing/word/word-processor/asp-net-mvc/restrict-editing)
