...
Move the selection to the document body from the header or footer region by double clicking or tapping the document area. You can also perform this by using the following code.
