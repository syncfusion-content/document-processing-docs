---
layout: post
title: Headers and Footers in JavaScript DOCX Editor | Syncfusion
description: Headers and footers in JavaScript DOCX Editor enable adding and customizing content at the top and bottom of document pages.
...
# Headers and Footers in JavaScript DOCX Editor
...
Explore how to add and customize headers and footers in Word documents using the JavaScript (ES5) Document Editor in this live demo [here](https://document.syncfusion.com/demos/docx-editor/javascript-es5/#/material3/document-editor/headers-and-footers.html).
