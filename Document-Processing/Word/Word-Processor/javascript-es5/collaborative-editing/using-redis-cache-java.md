---
layout: post
title: Collaborative Editing in JavaScript (ES5) with Redis in Java | Syncfusion
...
{% include code-snippet/document-editor/javascript-es5/collaborative-editing-java-cs1/index.js %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/document-editor/javascript-es5/collaborative-editing-java-cs1/script-1.js %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/document-editor/javascript-es5/collaborative-editing-java-cs1/script-2.js %}
{% endhighlight %}
{% endtabs %}
...
{% tabs %}
{% highlight js tabtitle="index.js" %}
{% include code-snippet/document-editor/javascript-es5/collaborative-editing-java-cs1/script-3.js %}
{% endhighlight %}
{% endtabs %}
