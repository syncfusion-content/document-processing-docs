...
The Syncfusion [JavaScript Document Editor](https://www.syncfusion.com/docx-editor-sdk/javascript-docx-editor) provides an extensive and flexible API to customize the built-in ribbon UI. You can:
