---
layout: post
title: Get current word in EJ2 Javascript Document editor control | Syncfusion
description: Learn here all about Get current word in Syncfusion EJ2 Javascript Document editor control of Syncfusion Essential JS 2 and more.
