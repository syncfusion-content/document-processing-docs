...
Using the [`resize`](https://ej2.syncfusion.com/javascript/documentation/api/document-editor#resize) method, you can change the height and width of the DOCX Editor.
