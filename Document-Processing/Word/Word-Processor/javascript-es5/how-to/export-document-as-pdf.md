---
layout: post
title: Export PDF in JavaScript (ES5) DOCX Editor | Syncfusion
description: Learn how to export a document as PDF in Syncfusion JavaScript (ES5) Document Editor using client-side exportAsImage API and server-side DocIO conversion.
...
# Export Document as PDF in JavaScript (ES5) Document Editor
...
With the help of [`Syncfusion DocIO`](https://help.syncfusion.com/file-formats/docio/word-to-pdf), you can export the document as PDF on the server side. Here, the exported PDF supports text search.
...
* Finally, convert the stream to a PDF using the [`Syncfusion.DocIORenderer.Net.Core`](https://www.nuget.org/packages/Syncfusion.DocIORenderer.Net.Core) library.
