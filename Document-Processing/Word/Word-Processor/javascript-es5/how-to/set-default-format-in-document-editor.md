...
You can set the default character format, paragraph format and section format in [JavaScript Document Editor](https://www.syncfusion.com/docx-editor-sdk/javascript-docx-editor).
