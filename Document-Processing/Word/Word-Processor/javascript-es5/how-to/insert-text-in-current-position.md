...
You can insert the text, paragraph and rich-text content in [JavaScript Document Editor](https://www.syncfusion.com/docx-editor-sdk/javascript-docx-editor) component.
