---
layout: post
title: How to insert text in EJ2 Javascript Document editor | Syncfusion
description: Learn here all about Insert text in current position in Syncfusion EJ2 Javascript Document editor control of Syncfusion Essential JS 2 and more.
...
# Insert text in current position in EJ2 Javascript Document editor
...
To insert the HTML content, you have to convert the HTML content to SFDT Format using [`web service`](../web-services-overview). Then use [`paste`](https://ej2.syncfusion.com/javascript/documentation/api/document-editor/editor#paste) API to insert the sfdt at current cursor position.
