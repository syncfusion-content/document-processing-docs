...
Like `restrictEditing`, you can use the [`isReadOnly`](https://ej2.syncfusion.com/javascript/documentation/api/document-editor#isreadonly) property in the DOCX Editor to disable header and footer editing.
