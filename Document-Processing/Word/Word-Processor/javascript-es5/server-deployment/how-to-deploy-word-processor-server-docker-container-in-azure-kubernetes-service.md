---
layout: post
title: How to Deploy JavaScript DOCX Editor Docker image on AKS | Syncfusion
description: Deploy the Syncfusion® JavaScript DOCX Editor Docker image to Azure Kubernetes Service (AKS) for scalable and reliable document processing.
