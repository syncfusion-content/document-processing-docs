---
layout: post
title: Save to Box cloud file storage in JS (ES5) DOCX Editor | Syncfusion
description: Learn about how to save a document to Box cloud file storage in the Syncfusion JavaScript (ES5) Document Editor of Syncfusion Essential JS 2 and more details.
...
# Save document to Box cloud file storage in JavaScript (ES5)
