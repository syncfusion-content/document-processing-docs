---
layout: post
title: Ribbon in JavaScript (ES5) DOCX Editor | Syncfusion
description: Learn here all about the Ribbon UI in the Syncfusion JavaScript (ES5) Document Editor, how to switch between Ribbon and Toolbar modes.
