...
You can deploy web APIs for server-side dependencies of [TypeScript Document Editor](https://www.syncfusion.com/docx-editor-sdk/javascript-docx-editor) component in the following platforms.
