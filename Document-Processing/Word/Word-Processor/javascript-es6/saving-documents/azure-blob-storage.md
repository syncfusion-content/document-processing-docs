---
layout: post
title: Save document to Azure Blob Storage in JavaScript (ES6) DOCX Editor | Syncfusion
...
# Save document to Azure Blob Storage in JavaScript (ES6) Document Editor
