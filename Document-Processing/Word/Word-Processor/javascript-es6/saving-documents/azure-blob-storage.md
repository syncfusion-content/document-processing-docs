---
layout: post
title: Save document to Azure Blob Storage in EJ2 TypeScript Document editor control | Syncfusion
description:  Learn about how to Save document to Azure Blob Storage in EJ2 TypeScript Document editor control of Syncfusion Essential JS 2 and more details.
...
{% include code-snippet/document-editor/javascript-es6/document-editor/save-azure-blob/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/document-editor/javascript-es6/document-editor/save-azure-blob/index.html %}
{% endhighlight %}
{% endtabs %}
