...
Follow the instructions provided in this [link](../getting-started) to create a simple DOCX Editor sample in TypeScript (ES6). This will give you a basic setup of the DOCX Editor component.
