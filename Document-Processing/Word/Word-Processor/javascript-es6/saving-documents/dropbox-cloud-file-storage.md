---
layout: post
title: Save document to Dropbox cloud file storage in JavaScript (ES6) DOCX Editor | Syncfusion
...
# Save document to Dropbox cloud file storage in JavaScript (ES6) Document Editor
...
{% include code-snippet/document-editor/javascript-es6/save-dropbox-cloud-file-storage/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/document-editor/javascript-es6/save-dropbox-cloud-file-storage/index.html %}
{% endhighlight %}
{% endtabs %}
