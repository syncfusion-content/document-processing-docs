---
layout: post
title: Import in TypeScript DOCX Editor | Syncfusion
description: The Import feature in TypeScript DOCX Editor enables users to load and edit documents from supported formats while preserving content structure.
...
# Import in TypeScript DOCX Editor

In [TypeScript DOCX Editor](https://www.syncfusion.com/docx-editor-sdk/javascript-docx-editor) (Document Editor), the documents are stored in DOCX Editor's own format called **Syncfusion Document Text (SFDT)**.
...
{% include code-snippet/document-editor/javascript-es6/import-cs1/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/document-editor/javascript-es6/import-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "/document-processing/code-snippet/document-editor/javascript-es6/import-cs1" %}
...
The following example shows how to import a document from the local machine.
 ...
 {% tabs %}
{% highlight ts tabtitle="index.ts" %}
{% include code-snippet/document-editor/javascript-es6/import-sfdt-cs1/index.ts %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/document-editor/javascript-es6/import-sfdt-cs1/index.html %}
{% endhighlight %}
{% endtabs %}
        
{% previewsample "/document-processing/code-snippet/document-editor/javascript-es6/import-sfdt-cs1" %}
