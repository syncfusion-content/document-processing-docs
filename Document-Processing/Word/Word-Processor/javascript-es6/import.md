---
layout: post
title: Import in JavaScript (ES6) DOCX Editor control | Syncfusion
description: Learn here all about Import in Syncfusion JavaScript (ES6) Document Editor control of Syncfusion Essential JS 2 and more.
