...
To load a document from Google Cloud Storage in a [TypeScript Document Editor](https://www.syncfusion.com/docx-editor-sdk/javascript-docx-editor), you can follow the steps below
