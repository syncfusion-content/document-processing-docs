---
layout: post
title: Paragraph format in EJ2 TypeScript Document editor control | Syncfusion
description: Learn here all about Paragraph format in Syncfusion EJ2 TypeScript Document editor control of Syncfusion Essential JS 2 and more.
