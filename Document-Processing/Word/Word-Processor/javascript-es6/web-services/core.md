---
layout: post
title: ASP.NET Core Web Service in TypeScript DOCX Editor | Syncfusion
description: Configure ASP.NET Core web services in the TypeScript DOCX Editor to handle server-side operations such as Word document import, export, and more.
