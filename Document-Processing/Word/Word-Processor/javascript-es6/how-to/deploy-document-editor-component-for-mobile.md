...
Hence, it is recommended to switch the DOCX Editor component to read-only mode in mobile browsers. Also, invoke the [`fitPage`](https://ej2.syncfusion.com/documentation/api/document-editor#fitpage) method with the [`FitPageWidth`](https://ej2.syncfusion.com/documentation/api/document-editor/pageFitType) parameter in the document change event to display one full page by adjusting the zoom factor.
