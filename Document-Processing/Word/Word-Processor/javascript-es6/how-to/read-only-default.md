---
layout: post
title: Read-Only by Default in JavaScript (ES6) DOCX Editor control | Syncfusion
description: Learn here all about opening a document in read-only mode by default in Syncfusion JavaScript (ES6) Document Editor control of Syncfusion Essential JS 2 and more.
...
# Read-Only by Default in JavaScript (ES6) Document Editor control
