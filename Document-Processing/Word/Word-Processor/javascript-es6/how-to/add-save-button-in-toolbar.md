---
layout: post
title: Add Save Button in Toolbar in TypeScript DOCX Editor | Syncfusion
description: Add a custom save button to the toolbar in Syncfusion® TypeScript DOCX Editor, customize toolbar items, and perform document save operations.
