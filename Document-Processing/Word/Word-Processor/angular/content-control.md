...
Content controls can be inserted using the [`insertContentControl`](https://ej2.syncfusion.com/angular/documentation/api/document-editor/editor#insertcontentcontrol) method in the editor module.
