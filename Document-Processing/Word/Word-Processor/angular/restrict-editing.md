...
@Component({
  ...
  template: `<ejs-documenteditorcontainer #documenteditor [serviceUrl]='serviceLink' height="590px" [enableToolbar]=true>
...
export class AppComponent {
  ...
  ngAfterViewInit() {
    ...
    this.container.documentEditor.open(JSON.stringify(sfdt));
  }
