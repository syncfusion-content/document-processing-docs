...
[Angular Document Editor](https://www.syncfusion.com/docx-editor-sdk/angular-docx-editor) provides support for restricting editing within a document. It enables control over how and where content can be modified. This helps limit editing so only specific sections of the document can be changed.

## Configure on client side

The Document Editor provides options to protect and unprotect a document using the [enforceProtection](https://ej2.syncfusion.com/angular/documentation/api/document-editor/editor#enforceprotection) and [stopProtection](https://ej2.syncfusion.com/angular/documentation/api/document-editor/editor#stopprotection) APIs, enabling various restrict-editing operations.
...
standalone: true,
    ...
    template: `<ejs-documenteditorcontainer #document_editor (created)="onCreated()" height="600px" style="display:block" [enableToolbar]=true> </ejs-documenteditorcontainer>
