---
layout: post
title: Collaborative Editing in Angular using ASP.NET Core | Syncfusion
description: The collaborative editing feature in Angular DOCX Editor supports real-time multi-user document editing using the Syncfusion Collaborator common packages with Redis and ASP.NET Core.
