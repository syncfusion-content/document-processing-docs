...
description: Learn about the Angular Document Editor control, which enables you to create, edit, view, and print Word documents.
...
# Overview of the Angular Document Editor
