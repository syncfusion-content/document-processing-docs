---
layout: post
title: Save to Google Drive in Angular DOCX Editor | Syncfusion
description: Save documents to Google Drive from Angular DOCX Editor, enabling cloud storage integration and streamlined document management.
...
# Save Documents to Google Drive in Angular DOCX Editor
...
**Step 2:** Create a Simple [Angular Document Editor](https://www.syncfusion.com/docx-editor-sdk/angular-docx-editor) (Document Editor) sample in Angular.
...
N> 3. You must use a unique `Client_ID` from json file to interface your application with the Google Drive API in order to save document directly to Google Drive. This Client_ID will serve as the authentication key, allowing you to save files securely.
