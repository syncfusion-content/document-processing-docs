---
layout: post
title: Java Web Service in Angular DOCX Editor | Syncfusion
description: Configure Java web services in the Angular DOCX Editor to handle server-side operations such as Word document import, export, spell checking, and more.
...
To know more about configuring spell check, please check this [link](https://github.com/SyncfusionExamples/EJ2-DocumentEditor-WebServices).
...
N> Please refer to the [Java Web API example from GitHub](https://github.com/SyncfusionExamples/EJ2-DocumentEditor-WebServices).