---
layout: post
title: View in Angular DOCX Editor | Syncfusion
description: View in Angular DOCX Editor enables web layout, ruler display, and heading navigation to enhance document readability and navigation.
control: View 
...
N> The default value of [`layoutType`](https://ej2.syncfusion.com/angular/documentation/api/document-editor#layouttype) in the DOCX Editor Container component is [`Pages`](https://ej2.syncfusion.com/angular/documentation/api/document-editor/layoutType).

### Online Demo

Explore how to view Word documents in web layout using the Angular DOCX Editor in this [live demo](https://document.syncfusion.com/demos/docx-editor/angular/#/tailwind3/document-editor/web-layout).
...
Explore how to use the ruler in the Angular DOCX Editor for working with Word documents in this [live demo](https://document.syncfusion.com/demos/docx-editor/angular/#/tailwind3/document-editor/ruler).
