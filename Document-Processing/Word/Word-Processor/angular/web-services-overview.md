...
You can deploy web APIs for server-side dependencies of [Angular DOCX Editor](https://www.syncfusion.com/docx-editor-sdk/angular-docx-editor) component in the following platforms.
