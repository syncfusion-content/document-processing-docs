...
In [Angular DOCX Editor](https://www.syncfusion.com/docx-editor-sdk/angular-docx-editor), the documents are stored in its own format called **Syncfusion Document Text (SFDT)**.
