---
layout: post
title: How to Retrieve Bookmark Content in Angular DOCX Editor | Syncfusion
description: Retrieve bookmark content as plain text and retrieve document data in SFDT format using Syncfusion® Angular DOCX Editor.
