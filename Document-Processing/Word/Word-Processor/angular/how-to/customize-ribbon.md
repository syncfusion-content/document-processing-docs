...
The [Angular DOCX Editor](https://www.syncfusion.com/docx-editor-sdk/angular-docx-editor) provides an extensive and flexible API to customize the built-in ribbon UI. You can:
