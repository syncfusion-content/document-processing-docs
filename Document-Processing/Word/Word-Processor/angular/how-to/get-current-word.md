...
You can get the current word or paragraph content from the [Angular DOCX Editor](https://www.syncfusion.com/docx-editor-sdk/angular-docx-editor) (Document Editor) component as plain text and SFDT (rich text).
