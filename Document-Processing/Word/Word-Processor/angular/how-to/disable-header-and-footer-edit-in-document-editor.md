...
Like restrictEditing, you can use [`isReadOnly`](https://ej2.syncfusion.com/angular/documentation/api/document-editor#isreadonly) property in DOCX Editor to disable header and footer edit.
