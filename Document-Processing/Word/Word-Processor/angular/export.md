...
[Angular DOCX Editor](https://www.syncfusion.com/docx-editor-sdk/angular-docx-editor) exports the document into various known file formats in client-side such as Microsoft Word document (.docx), text document (.txt), and its own format called **Syncfusion Document Text (.sfdt)**.
