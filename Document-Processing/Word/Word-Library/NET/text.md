---
title: Convert Word to Text document and vice versa in C# |Syncfusion<sup>®</sup>
...
The Essential<sup>®</sup> DocIO converts the Word document into Text file and vice versa. 
