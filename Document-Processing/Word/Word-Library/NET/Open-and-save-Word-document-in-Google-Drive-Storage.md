---
title: Open and save Word document in Google Drive Cloud Storage | Syncfusion<sup>®</sup>
description: Open and save Word document in Google Drive Cloud Storage using Syncfusion<sup>®</sup> .NET Core Word (DocIO) library without Microsoft Word or interop dependencies.
