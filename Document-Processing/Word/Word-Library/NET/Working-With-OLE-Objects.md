---
title: Working with OLE Objects in .NET Word library | Syncfusion<sup>®</sup>
description: Learn how to work with OLE Objects in a Word document using the Syncfusion<sup>®</sup> .NET Word (DocIO) library.
