---
title: RTF conversions in C# | DocIO | Syncfusion<sup>®</sup>
...
The Essential<sup>®</sup> DocIO converts the RTF document into Word document and vice versa. The following code shows how to convert RTF document into Word document.
