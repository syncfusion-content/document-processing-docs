---
title: Convert Word document to ODT in C# | DocIO | Syncfusion<sup>®</sup>
...
The Essential<sup>®</sup> DocIO supports converting the Word document into ODT file. The following code example shows how to convert the Word document into ODT file.

N> Refer to the appropriate tabs in the code snippets section: ***C# [Cross-platform]*** for ASP.NET Core, Blazor, Xamarin, UWP, .NET MAUI, and WinUI; ***C# [Windows-specific]*** for WinForms and WPF; ***VB.NET [Windows-specific]*** for VB.NET applications.

{% tabs %}

{% highlight c# tabtitle="C# [Cross-platform]" playgroundButtonLink="https://raw.githubusercontent.com/SyncfusionExamples/DocIO-Examples/main/Word-to-ODT-conversion/Convert-Word-to-ODT/.NET/Convert-Word-to-ODT/Program.cs" %}
