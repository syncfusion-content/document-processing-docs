---
title: Create a simple Word document in C#, VB.NET | Syncfusion<sup>®</sup>
...
In this page, you can see how to create a simple Word document by using Essential<sup>®</sup> DocIO’s API. For creating and manipulating a Word document, the following assemblies are required to be referenced in your application.
...
Essential<sup>®</sup> DocIO allow you to create simple and multi-level lists. The following code snippet explains about how to create a numbered and bulleted list.
...
Essential<sup>®</sup> DocIO allows you to manipulate an existing Word document, RTF, WordML, HTML and Plain text files. You can modify the documents either by manipulating DocIO’s DOM or by using DocIO’s built-in functionalities such as Find and Replace, replacing bookmark contents etc.
...
Essential<sup>®</sup> DocIO allows to generate documents by filling data in template document from data source. Mail merge operation automatically maps the column name in the data source and names of the merge fields in the template Word document and fills the data.  
...
Essential<sup>®</sup> DocIO allows you to convert a Word document into PDF document in a few lines of code. 
