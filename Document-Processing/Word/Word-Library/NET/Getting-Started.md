...
* Explore how to create a simple Word document with text, an image, and a table using the .NET Word Library (DocIO) in a live demo [here](https://document.syncfusion.com/demos/word/helloworld#/tailwind).
