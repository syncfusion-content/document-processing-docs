---
title: Open and save Word document on Mac OS | Syncfusion&reg;
description: Open and save Word document in .NET Core application on macOS using Syncfusion&reg; .NET Core Word (DocIO) library.
