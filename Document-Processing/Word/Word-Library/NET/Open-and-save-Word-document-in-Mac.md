---
title: Open and save Word document on Mac OS | Syncfusion<sup>®</sup>
description: Open and save Word document in .NET Core application on macOS using Syncfusion<sup>®</sup> .NET Core Word (DocIO) library.
