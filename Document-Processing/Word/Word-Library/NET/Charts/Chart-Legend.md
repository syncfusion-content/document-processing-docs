---
title: Modify the Appearance of Legend | Syncfusion<sup>®</sup>
description: Learn how to modify the appearance of legend in a chart in a Word document using Syncfusion<sup>®</sup> .NET Word (DocIO) library without Microsoft Word.
