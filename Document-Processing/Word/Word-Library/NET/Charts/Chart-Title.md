---
title: Modify the Appearance of Chart Title | Syncfusion<sup>®</sup>
description: Learn how to modify the appearance of chart title in a chart in a Word document using Syncfusion<sup>®</sup> .NET Word (DocIO) library without Microsoft Word.
