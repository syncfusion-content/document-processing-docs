---
title: Modify the Appearance of Axes in Chart | Syncfusion<sup>®</sup>
description: Learn how to modify the appearance of axes in a chart in a Word document using the Syncfusion<sup>®</sup> .NET Word (DocIO) library without Microsoft Word.
