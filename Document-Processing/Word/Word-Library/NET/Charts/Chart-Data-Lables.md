---
title: Modify the Appearance of Data Labels | Syncfusion&reg;
description: Learn how to modify the appearance of data labels in a chart in a Word document using Syncfusion&reg; .NET Word (DocIO) library without Microsoft Word.
