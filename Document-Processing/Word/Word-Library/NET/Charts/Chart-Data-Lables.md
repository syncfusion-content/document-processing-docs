---
title: Modify the Appearance of Data Labels | Syncfusion<sup>®</sup>
description: Learn how to modify the appearance of data labels in a chart in a Word document using Syncfusion<sup>®</sup> .NET Word (DocIO) library without Microsoft Word.
