---
title: Create Word document in Microsoft Azure | Syncfusion<sup>®</sup>
description: Learn how to create a Word document in Azure services using Syncfusion<sup>®</sup> .NET Word (DocIO) library in C#.
