---
title: Working with Silverlight using Syncfusion<sup>®</sup> Word library
description: Creating a Silverlight application, load the Word document and save the document with Syncfusion<sup>®</sup> Word library
