...
Step 6: Add the following code in **DocIO.razor** file to create and download the **Word document**.
...
Step 8: Create a new MemoryStream method with name as **CreateWord** in **WordService** class and include the following code snippet to **create a simple Word document in Blazor** Server app.
...
builder.Services.AddScoped<Create-Word-document.Data.WordService>();
