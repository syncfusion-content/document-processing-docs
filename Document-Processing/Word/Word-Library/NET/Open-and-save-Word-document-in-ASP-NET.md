---
title: Open and save Word document in ASP.NET | Syncfusion<sup>®</sup>
description: Open and save Word document in ASP.NET application using Syncfusion<sup>®</sup> .NET Word (DocIO) library without Microsoft Word or interop dependencies.
