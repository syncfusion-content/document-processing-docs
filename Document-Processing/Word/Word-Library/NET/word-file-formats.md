---
title: Word file format conversions in C# | DocIO | Syncfusion<sup>®</sup>
...
# Word File Formats in Essential<sup>®</sup> DocIO

The [Microsoft Word's](https://en.wikipedia.org/wiki/Microsoft_Word#) native file formats are DOC, DOCX, RTF, DOT, DOTX, DOCM, and DOTM. The Essential<sup>®</sup> DocIO supports the following major native file formats.
