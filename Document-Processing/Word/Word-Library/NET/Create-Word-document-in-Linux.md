---
title: Create Word document on Linux | Syncfusion<sup>®</sup>
description: Create Word document in .NET Core application on Linux using Syncfusion<sup>®</sup> .NET Core Word (DocIO) library without Microsoft Word or interop dependencies.
