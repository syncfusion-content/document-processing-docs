---
title: Create Word document on Linux | Syncfusion&reg;
description: Create Word document in .NET Core application on Linux using Syncfusion&reg; .NET Core Word (DocIO) library without Microsoft Word or interop dependencies.
