---
title: Create Word document in WPF | Syncfusion<sup>®</sup> 
description: Create Word document without Microsoft Word or interop dependencies in WPF application using Syncfusion<sup>®</sup> .NET Word (DocIO) library.
