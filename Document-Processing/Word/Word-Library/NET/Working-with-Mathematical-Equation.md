---
title: Working with Mathematical Equation | DocIO | Syncfusion<sup>®</sup>
...
The following different structures of equation can be created by using the Essential<sup>®</sup> DocIO.
