---
title: Mail merge for nested groups in .NET Word | Syncfusion
description: Learn how to Mail merge for nested groups - replace merge fields in nested regions of document with relational data using the .NET Word library.
platform: document-processing
control: DocIO
documentation: UG
---

# Mail merge for nested groups in .NET Word
...
{% highlight c# tabtitle="C# [Cross-platform]" playgroundButtonLink="https://raw.githubusercontent.com/SyncfusionExamples/DocIO-Examples/main/Mail-Merge/Mail-merge-with-dynamic-objects/.NET/Mail-merge-with-dynamic-objects/Program.cs" %}
//Opens the template document
...
{% highlight c# tabtitle="C# [Cross-platform]" playgroundButtonLink="https://raw.githubusercontent.com/SyncfusionExamples/DocIO-Examples/main/Mail-Merge/Mail-merge-with-implicit-relational-data/.NET/Mail-merge-with-implicit-relational-data/Program.cs" %}
//Opens the template document 
FileStream fileStreamPath = new FileStream("Template.docx", FileMode.Open, FileAccess.Read, FileShare.ReadWrite);
WordDocument document = new WordDocument(fileStreamPath, FormatType.Docx);
