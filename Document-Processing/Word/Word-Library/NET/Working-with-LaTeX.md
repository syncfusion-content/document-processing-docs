...
{% highlight c# tabtitle="C# [Cross-platform]" playgroundButtonLink="https://raw.githubusercontent.com/SyncfusionExamples/DocIO-Examples/refs/heads/main/Mathematical-Equation/Apply-math-justification/NET/Apply-math-justification/Program.cs" %}
{% raw %}
// Create a new Word document.
using (WordDocument document = new WordDocument())
{
