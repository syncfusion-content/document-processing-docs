---
title: Create Word document in .NET MAUI | Syncfusion<sup>®</sup>
description: Create Word document without Microsoft Word or interop dependencies in .NET MAUI application using Syncfusion<sup>®</sup> .NET MAUI Word (DocIO) library.
