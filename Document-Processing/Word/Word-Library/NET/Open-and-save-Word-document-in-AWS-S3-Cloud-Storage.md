---
title: Open and save Word document in AWS S3 Cloud Storage | Syncfusion<sup>&reg;</sup>
description: Open and save Word document in AWS S3 Cloud Storage using Syncfusion<sup>&reg;</sup> .NET Core Word (DocIO) library without Microsoft Word or interop dependencies.
