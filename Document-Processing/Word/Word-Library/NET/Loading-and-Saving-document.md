---
title: Loading & Saving Word document in C# | DocIO | Syncfusion<sup>®</sup>
description: Learn to open and save the Word document in C# and VB.NET using Syncfusion<sup>®</sup> .NET Word (DocIO) library without Microsoft Word or interop dependencies.
...
The following namespaces of Essential<sup>®</sup> DocIO need to be included in your application to load and save the Word document.
