---
title: Create Word document in Xamarin | 
Syncfusion<sup>&reg;</sup>
description: Create Word document without Microsoft Word or interop dependencies in Xamarin application using 
Syncfusion<sup>&reg;</sup> Xamarin Word (DocIO) library.
