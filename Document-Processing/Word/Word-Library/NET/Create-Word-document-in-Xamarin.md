---
title: Create Word document in Xamarin | Syncfusion<sup>®</sup>
description: Create Word document without Microsoft Word or interop dependencies in Xamarin application using Syncfusion<sup>®</sup> Xamarin Word (DocIO) library.
