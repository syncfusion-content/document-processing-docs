...
Syncfusion<sup>&reg;</sup> Word offline installer from our 
...
6. Click the More Download Options (element 2 in the above screenshot) button to get the Essential Studio<sup>&reg;</sup> Word Offline trial installer which is available in EXE and ZIP format.
