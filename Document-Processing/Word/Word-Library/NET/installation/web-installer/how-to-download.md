...
1. Syncfusion licensed products will be available in the [License & Downloads](https://www.syncfusion.com/account/downloads) page under your registered Syncfusion<sup>&reg;</sup> account.
...
8. After downloading, the Syncfusion<sup>&reg;</sup> Word web installer can be unlocked using Syncfusion<sup>&reg;</sup> registered login credential.
