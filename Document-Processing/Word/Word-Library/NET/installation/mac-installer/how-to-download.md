...
description: Learn here about the how to download Syncfusion<sup>&reg;</sup> Word Mac installer from our Syncfusion<sup>&reg;</sup> website with license.
...
4. Unlock key is not required to install the Syncfusion<sup>&reg;</sup> Word Mac trial installer.
5. Before the trial expires, you can download the trial installer at any time from your registered account’s [Trials & Downloads](https://www.syncfusion.com/account/manage-trials/downloads) page (as shown in below screenshot.)
 
   ![Trial and downloads of Syncfusion Essential Studio](images/trial-download.png)

6. Click the More Download Options (element 2 in the above screenshot) button to get the Essential Studio<sup>&reg;</sup> Word Mac trial installer which is available in DMG format.
