---
title: Create Word document in ASP.NET Core | Syncfusion<sup>®</sup>
description: Create Word document without Microsoft Word or interop dependencies in ASP.NET Core application using Syncfusion<sup>®</sup> .NET Core Word (DocIO) library.
