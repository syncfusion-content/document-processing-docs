...
* Essential<sup>®</sup> DocIO allows [PDF document for accessibility (508 compliance)]() support.
...
* Essential<sup>®</sup> DocIO allows [hyphenating text]() in a Word document while converting it to PDF format.
