---
title: Create Word document on Mac OS | Syncfusion&reg;
description: Create Word document in ASP.NET Core application on macOS using Syncfusion&reg; .NET Core Word (DocIO) library without Microsoft Word or interop dependencies.
