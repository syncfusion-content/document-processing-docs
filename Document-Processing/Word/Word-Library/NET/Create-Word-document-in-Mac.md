---
title: Create Word document on Mac OS | Syncfusion<sup>®</sup>
description: Create Word document in ASP.NET Core application on macOS using Syncfusion<sup>®</sup> .NET Core Word (DocIO) library without Microsoft Word or interop dependencies.
