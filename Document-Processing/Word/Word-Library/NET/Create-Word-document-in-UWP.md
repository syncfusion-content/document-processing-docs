---
title: Create Word document in UWP | 
Syncfusion<sup>&reg;</sup>
description: Create Word document without Microsoft Word or interop dependencies in UWP application using 
Syncfusion<sup>&reg;</sup> UWP Word (DocIO) library.
