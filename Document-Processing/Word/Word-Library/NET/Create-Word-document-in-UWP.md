---
title: Create Word document in UWP | Syncfusion<sup>®</sup>
description: Create Word document without Microsoft Word or interop dependencies in UWP application using Syncfusion<sup>®</sup> UWP Word (DocIO) library.
