---
title: Open and save Word document on Linux | Syncfusion&reg;
description: Open and save Word document in .NET Core application on Linux using Syncfusion&reg; .NET Core Word (DocIO) library.
