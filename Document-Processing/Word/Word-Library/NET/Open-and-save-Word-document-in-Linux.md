---
title: Open and save Word document on Linux | Syncfusion<sup>®</sup>
description: Open and save Word document in .NET Core application on Linux using Syncfusion<sup>®</sup> .NET Core Word (DocIO) library.
