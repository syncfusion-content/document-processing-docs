---
title: Create Word document in WinUI | Syncfusion<sup>®</sup>
description: Create Word document without Microsoft Word or interop dependencies in WinUI application using Syncfusion<sup>®</sup> WinUI Word (DocIO) library.
