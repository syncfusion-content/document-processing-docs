---
title: Create Word document in WinUI | 
Syncfusion<sup>&reg;</sup>
description: Create Word document without Microsoft Word or interop dependencies in WinUI application using 
Syncfusion<sup>&reg;</sup> WinUI Word (DocIO) library.
