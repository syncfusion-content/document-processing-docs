---
title: Open and save Word document in Blazor | DocIO | Syncfusion<sup>®</sup> 
description: Open and save Word document in Blazor application using Syncfusion<sup>®</sup> .NET Word (DocIO) library without Microsoft Word or interop dependencies.
