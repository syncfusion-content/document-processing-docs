---
title: Create Word document in ASP.NET | Syncfusion<sup>®</sup> 
description: Create Word document without Microsoft Word or interop dependencies in ASP.NET application using Syncfusion<sup>®</sup> .NET Word (DocIO) library.
