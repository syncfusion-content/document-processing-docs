---
title: Open and save Word document in AWS | Syncfusion<sup>®</sup>
description: Learn how to open and save Word document in Amazon Web Services (AWS) using Syncfusion<sup>®</sup> .NET Core Word (DocIO) library in C#.
