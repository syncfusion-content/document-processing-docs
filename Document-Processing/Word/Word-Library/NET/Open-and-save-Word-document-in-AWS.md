---
title: Open and save Word document in AWS | Syncfusion&reg;
description: Learn how to open and save Word document in Amazon Web Services (AWS) using Syncfusion&reg; .NET Core Word (DocIO) library in C#.
