---
title: Migration from Office Automation to DocIO | DocIO | Syncfusion<sup>®</sup>
description: This section illustrates how to migrate from Word Interop to the Syncfusion<sup>®</sup> .NET Word (DocIO) library.
