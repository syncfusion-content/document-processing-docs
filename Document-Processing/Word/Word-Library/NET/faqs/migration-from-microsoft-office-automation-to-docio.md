---
title: Migration from Office Automation to DocIO | DocIO | Syncfusion&reg;
description: This section illustrates how to migrate from Word Interop to the Syncfusion&reg; .NET Word (DocIO) library.
