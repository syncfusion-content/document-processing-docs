...
Similarly, the [Syncfusion.Drawing.ColorTranslator.FromHtml](https://help.syncfusion.com/cr/winui/Syncfusion.Drawing.ColorTranslator.html#Syncfusion_Drawing_ColorTranslator_FromHtml_System_String_) function behaves the same as the [System.Drawing.ColorTranslator.FromHtml](https://learn.microsoft.com/en-us/dotnet/api/system.drawing.colortranslator.fromhtml?view=net-9.0) function, and it does not parse #rrggbbaa hex color notation.