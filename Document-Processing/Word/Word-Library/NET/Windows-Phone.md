---
title: Working with Windows phone using Syncfusion<sup>®</sup> Word library
description: Create a Windows phone application, load the word document and save the word document with Syncfusion<sup>®</sup> Word library
