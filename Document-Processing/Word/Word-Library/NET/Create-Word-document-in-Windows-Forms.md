---
title: Create Word document in Windows Forms | Syncfusion<sup>®</sup> 
description: Create Word document without Microsoft Word or interop dependencies in Windows Forms application using Syncfusion<sup>®</sup> .NET Word (DocIO) library.
