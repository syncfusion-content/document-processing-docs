---
title: Working with Charts in Word document | DocIO | Syncfusion<sup>®</sup>
...
Essential<sup>®</sup> DocIO allows to modify the side wall, back wall, floor of the 3D chart. The following code snippet illustrates how to apply properties for side wall, floor and back wall of a 3D chart.
...
Essential<sup>®</sup> DocIO supports creating and manipulating new and modern chart types such as waterfall, which is introduced in Microsoft Word 2016.
