---
title: Open and save Word document in Xamarin | Syncfusion<sup>®</sup>
description: Open and save Word document in Xamarin application using Syncfusion<sup>®</sup> Xamarin Word (DocIO) library without Microsoft Word or interop dependencies.
...
Click [here](https://www.syncfusion.com/document-processing/word-framework/xamarin) to explore the rich set of Syncfusion<sup>®</sup> Word library (DocIO) features. 