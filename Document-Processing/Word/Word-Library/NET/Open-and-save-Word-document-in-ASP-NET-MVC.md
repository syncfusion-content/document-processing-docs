---
title: Open and save Word document in ASP.NET MVC | Syncfusion<sup>®</sup>
description: Open and save Word document in ASP.NET MVC application using Syncfusion<sup>®</sup> .NET Word (DocIO) library without Microsoft Word or interop dependencies.
