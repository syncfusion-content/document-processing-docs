...
description: Explain the NuGet packages required for Word-to-image conversion using the Syncfusion .NET Word library
...
To convert a Word document to an image, the following NuGet packages need to be installed in your application. Ensure you have registered your Syncfusion<sup>&reg;</sup> license key in your project before using these packages.
...
<tr>
<td>
{{'[ASP.NET MVC4](https://help.syncfusion.com/document-processing/word/conversions/word-to-image/net/convert-word-document-to-image-in-asp-net-mvc)' | markdownify}}<br/>
</td>
<td>
...
* [Word to Image conversion overview](https://help.syncfusion.com/document-processing/word/conversions/word-to-image/net/word-to-image)
* [Assemblies required to convert Word to Image](https://help.syncfusion.com/document-processing/word/conversions/word-to-image/net/assemblies-required-word-to-image)
