...
## Word to Image in Blazor Web Server Application
...
To **convert a Word document to image in Web Server app**, install [Syncfusion.DocIORenderer.Net.Core](https://www.nuget.org/packages/Syncfusion.DocIORenderer.Net.Core) to the Blazor project.
...
![Word to Image in Blazor Web Server app](WordToPDF_images/Output-WordtoImage.png)
