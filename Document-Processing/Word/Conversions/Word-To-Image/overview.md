---
title: About Syncfusion .NET Word to Image Conversions | Syncfusion
description: Learn about the overview of the Syncfusion .NET Word to Image Conversion library, its key features, and more details in this section.
platform: document-processing
control: DocIO
documentation: UG
---

# About Syncfusion .NET Word to Image Conversions
...
* Ability to [register custom fonts](./NET/Custom-fonts-registration-word-to-image) from memory streams or a folder without installing them on the operating system.
...
For further information, click [here](./NET/Custom-fonts-registration-word-to-image).
