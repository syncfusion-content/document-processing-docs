---
title:  Convert Word to Image in Word Library  | DocIO | Syncfusion<sup>®</sup>
description:  Learn how to convert a Word document to image using the Syncfusion<sup>®</sup> Word (DocIO) library without Microsoft Word or interop dependencies. 
platform: document-processing
control: DocIO
documentation: UG
---

# Convert Word to Image using Syncfusion<sup>®</sup> Word (DocIO) library 
