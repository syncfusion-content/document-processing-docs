---
title: Convert Word to PDF in Word Library | DocIO | 
Syncfusion<sup>&reg;</sup>&reg;
description: Learn how to convert a Word document to PDF using the 
Syncfusion<sup>&reg;</sup> Word (DocIO) library without Microsoft Word or interop dependencies.
platform: document-processing
control: DocIO
documentation: UG
---

# Convert Word  to PDF using 
Syncfusion<sup>&reg;</sup> Word (DocIO) library 
...
During Word to PDF conversions, if a glyph of the input text is unavailable in the specified font, the text will not be rendered properly. To address this, the 
