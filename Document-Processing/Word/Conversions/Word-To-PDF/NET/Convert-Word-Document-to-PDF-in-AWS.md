---
title: Convert Word to PDF in AWS | Syncfusion<sup>®</sup>
description: Learn how to convert a Word document to a PDF in Amazon Web Services (AWS) using Syncfusion<sup>®</sup> .NET Core Word (DocIO) library in C#.
