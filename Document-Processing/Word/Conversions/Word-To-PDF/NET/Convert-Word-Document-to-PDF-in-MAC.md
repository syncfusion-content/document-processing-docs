...
description: Convert Word to PDF in a .NET Core console application on macOS using the Syncfusion .NET Core Word (DocIO) library without Microsoft Word or interop dependencies.
