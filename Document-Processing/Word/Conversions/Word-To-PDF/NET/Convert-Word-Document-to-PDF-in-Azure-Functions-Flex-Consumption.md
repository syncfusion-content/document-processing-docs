---
title: Convert Word to PDF in Azure Functions  | Syncfusion
description: Convert Word to PDF in Azure Functions Flex Consumption using .NET Core Word library without Microsoft Word or interop dependencies.
