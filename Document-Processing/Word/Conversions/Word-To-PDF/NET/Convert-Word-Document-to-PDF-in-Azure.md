---
title: Convert Word document to PDF in Microsoft Azure | Syncfusion<sup>®</sup>
description: Learn how to convert a Word document to a PDF in Azure services using Syncfusion<sup>®</sup> .NET Word (DocIO) library in C#.
