...
## Word to PDF in Blazor Web Server Application
...
To **convert a Word document to PDF in a Web Server app**, install [Syncfusion.DocIORenderer.Net.Core](https://www.nuget.org/packages/Syncfusion.DocIORenderer.Net.Core) into your Blazor project.
...
![Word to PDF in Blazor Web Server app](WordToPDF_images/OutputImage.png)
