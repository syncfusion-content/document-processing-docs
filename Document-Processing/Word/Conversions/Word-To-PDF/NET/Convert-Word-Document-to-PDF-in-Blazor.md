---
title: Convert Word to PDF in Blazor | DocIO | Syncfusion&reg; 
...
```
dotnet new blazorserver -o Convert-Word-to-PDF
cd Convert-Word-to-PDF
```

Step 3: To **convert a Word document to PDF in Blazor Server app**,run the following command to  install [Syncfusion.DocIORenderer.Net.Core](https://www.nuget.org/packages/Syncfusion.DocIORenderer.Net.Core) to the Blazor project.
...
Step 9: Register WordService as a Scoped Service in Program.cs file.

To register the WordService as a scoped service in your Blazor application, add the following line to the Program.cs and make sure to add the scoped services before call builder.Build() to build the application.  
{% tabs %}
{% highlight c# tabtitle="C#" %}

builder.Services.AddScoped<Convert_Word_to_PDF.Data.WordService>();
...
![Install Syncfusion.DocIORenderer.Net.Core NuGet Package](Blazor_Images/NugetPackage.png)
![Install SkiaSharp.Views.Blazor v2.88.8 NuGet Package](Blazor_Images/NuGet-Package-WordtoPDF.png)
...
{% tabcontent Visual Studio Code %}
Step 1: Create a new C# Blazor WASM app project. Open the terminal in Visual Studio Code.
...
Step 3: To **convert a Word document to PDF in Blazor WASM app**,run the following command to  install  the following **Nuget packages** in your application.
* [Syncfusion.DocIORenderer.Net.Core](https://www.nuget.org/packages/Syncfusion.DocIORenderer.Net.Core)
* [SkiaSharp.Views.Blazor v2.88.8](https://www.nuget.org/packages/SkiaSharp.Views.Blazor/2.88.8)
