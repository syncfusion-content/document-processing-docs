...
To **create a PowerPoint document in Web Server app**, install [Syncfusion.Presentation.Net.Core](https://www.nuget.org/packages/Syncfusion.Presentation.Net.Core) to the Blazor project.
...
<p>The Syncfusion Blazor Presentation library (Essential Presentation) used to create, read, edit, and convert Presentation files in your applications without Microsoft Office dependencies.</p>
...
Step 6: Create a new cs file `PresentationService` in the `Data` folder.
Include the following namespaces in the file:
...
Step 7: Implement the `CreatePowerPoint` method in `PresentationService.cs`.
Create a new `MemoryStream` method name `CreatePowerPoint` and include the following code snippet to **create a PowerPoint document in Blazor** Server app.
...
A complete working sample is available on [GitHub](https://github.com/SyncfusionExamples/PowerPoint-Examples/tree/master/Getting-started/Blazor/Blazor-Server-app).

Upon executing the program, the **PowerPoint document** will be generated as follows.

![Blazor Web Server app output PowerPoint document](Workingwith-Blazor/Output.png)
...
Step 2: Install the `Syncfusion.Presentation.Net.Core` NuGet package.
To **create a PowerPoint document in WASM app**, install [Syncfusion.Presentation.Net.Core](https://www.nuget.org/packages/Syncfusion.Presentation.Net.Core) to the Blazor project.
...
Step 5: Implement `CreatePowerPoint` method in `Presentation.razor`.
Create a new `async` method named `CreatePowerPoint` and include the following code snippet to **create a PowerPoint document in Blazor** WASM app.
...
A complete working sample is available on [GitHub](https://github.com/SyncfusionExamples/PowerPoint-Examples/tree/master/Getting-started/Blazor/Blazor-WASM-app).
...
A complete working sample is available [GitHub](https://github.com/SyncfusionExamples/PowerPoint-Examples/tree/master/Getting-started/Blazor/Blazor-WASM-app).
...
Step 2: Install the `Syncfusion.Presentation.Net.Core` NuGet package from [NuGet.org](https://www.nuget.org/).
...
Click the **Run** button (green arrow) or press <kbd>F5</kbd> to run the application.
...
N> While the PowerPoint library works in WASM app, server-side deployment is recommended. WASM app deployment increases the application payload size. You can also explore our [Blazor PowerPoint library demo](https://blazor.syncfusion.com/demos/powerpoint/getting-started) that shows how to create and modify PowerPoint files from C# with just five lines of code.
