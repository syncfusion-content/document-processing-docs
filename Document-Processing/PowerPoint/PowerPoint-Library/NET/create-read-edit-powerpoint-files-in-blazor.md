---
title: Create PowerPoint document in Blazor | PowerPoint | Syncfusion<sup>®</sup> 
...
* Install [.NET Core SDK 3.1 or Greater](https://dotnet.microsoft.com/en-us/download/dotnet/3.1)
