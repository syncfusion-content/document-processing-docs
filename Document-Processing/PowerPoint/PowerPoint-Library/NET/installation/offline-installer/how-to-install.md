...
1.	Open the Syncfusion<sup>&reg;</sup> PowerPoint offline installer file from downloaded location by double-clicking it. The Installer Wizard automatically opens and extracts the package.
...
2.	To unlock the Syncfusion<sup>&reg;</sup> offline installer, you have two options:
    ...
    **Use Unlock Key**
    ...
    Unlock keys are used to unlock the Syncfusion<sup>&reg;</sup> offline installer, and they are platform and version specific. You should use either Syncfusion<sup>&reg;</sup> licensed or trial Unlock key to unlock Syncfusion<sup>&reg;</sup> PowerPoint installer.
...
7.  Click the Finish button. Your system has been installed with the Syncfusion<sup>&reg;</sup> Essential Studio<sup>&reg;</sup> PowerPoint product.
