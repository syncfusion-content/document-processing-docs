---
layout: post
title: Installing Syncfusion&reg; PowerPoint web installer - Syncfusion&reg;
description: Learn here about how to install Syncfusion&reg; PowerPoint web installer after downloading from our Syncfusion&reg; website.
...
1.  Open the Syncfusion&reg; Essential Studio&reg; PowerPoint Web Installer file from downloaded location by double-clicking it. The Installer Wizard automatically opens and extracts the package.
...
2. 	The Syncfusion&reg; PowerPoint Web Installer's welcome wizard will be displayed. Click the Next button.
...
Syncfusion&reg; PowerPoint installer can be uninstalled in two ways.

   * Uninstall the PowerPoint using the Syncfusion&reg; PowerPoint web installer
   * Uninstall the PowerPoint from Windows Control Panel

Follow either one of the option below to uninstall Syncfusion&reg; Essential Studio&reg; PowerPoint installer.
  
**Option 1: Uninstall the PowerPoint using the Syncfusion&reg; PowerPoint web installer**
...
N> If the **Syncfusion&reg; Essential Studio&reg; for PowerPoint {version}** entry is selected from the Windows control panel, the Syncfusion&reg; Essential Studio&reg; PowerPoint alone will be removed and the below default MSI uninstallation window will be displayed.	

1.  The Syncfusion&reg; PowerPoint Web Installer's welcome wizard will be displayed. Click the Next button
