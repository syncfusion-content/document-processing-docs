---
layout: post
title: Downloading Syncfusion<sup>&reg;</sup> PowerPoint linux installer - Syncfusion<sup>&reg;</sup>
...
4. Unlock key is not required to install the Syncfusion<sup>&reg;</sup> PowerPoint Linux trial installer.
