---
title: Working with PowerPoint presentation | Syncfusion<sup>®</sup>
description: Working with PowerPoint presentation. Cloning the Presentation. Printing the Presentation. Essential<sup>®</sup> Presentation use Points to add slide elements.
...
You can access and modify the built in document properties of a PowerPoint presentation with Essential<sup>®</sup> Presentation library. The Built-in document properties of a PowerPoint presentation is represented by [IBuiltInDocumentProperties](https://help.syncfusion.com/cr/document-processing/Syncfusion.Presentation.IBuiltInDocumentProperties.html) type.
