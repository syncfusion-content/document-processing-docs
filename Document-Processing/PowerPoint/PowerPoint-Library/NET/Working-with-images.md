---
title: Add and edit images in PowerPoint slides|C# PowerPoint|Syncfusion<sup>®</sup>
description: Learn how to add, edit, and remove the images in C# using Syncfusion<sup>®</sup> .NET PowerPoint library without Microsoft PowerPoint or interop dependencies.
...
Essential<sup>®</sup> Presentation library facilitates adding or modifying the images in a PowerPoint Presentation. The following code example demonstrates how to add a new image to the presentation.
...
SVG images can be inserted in PowerPoint slide for displaying images with accuracy when scaling or zooming page. The Essential<sup>®</sup> Presentation library allows you to insert and edit an SVG image along with its fallback image.
