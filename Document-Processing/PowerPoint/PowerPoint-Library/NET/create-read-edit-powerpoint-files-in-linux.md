---
title: Create and edit PowerPoint files on Linux | Syncfusion<sup>®</sup>
...
You can create or edit a PowerPoint file in .NET Core on Linux using Syncfusion<sup>®</sup> PowerPoint library. The below are the steps.
