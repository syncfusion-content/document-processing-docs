---
title: Create and edit PowerPoint files in WPF |Syncfusion<sup>®</sup>|
...
You can create or edit a PowerPoint file in WPF with Syncfusion<sup>®</sup> PowerPoint library. The below are the steps.
