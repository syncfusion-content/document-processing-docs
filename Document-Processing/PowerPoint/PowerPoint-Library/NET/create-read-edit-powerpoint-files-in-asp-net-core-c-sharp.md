...
![Select the Syncfusion.Presentation.Net.Core NuGet package](ASP-NET-Core_images/Select-Syncfusion.Presentation.Net.Core-NuGet.png)

* Click the Install button to complete the installation.

![Install the Syncfusion.Presentation.Net.Core NuGet package](ASP-NET-Core_images/Install-Syncfusion.Presentation.Net.Core-NuGet.png)
