...
![Select the Syncfusion.Presentation.Net.Core NuGet package](MAUI_Images/Select-Syncfusion.Presentation.Net.Core-NuGet.png)

* Click the **Install** button to complete the installation.

![Install the Syncfusion.Presentation.Net.Core NuGet package](MAUI_Images/Install-Syncfusion.Presentation.Net.Core-NuGet.png)
