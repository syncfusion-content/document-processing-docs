...
* Download and install the **AWS Toolkit** for Visual Studio from this [link](https://aws.amazon.com/visualstudio/). The toolkit can be installed from **Extensions > Manage Extensions** in Visual Studio.
