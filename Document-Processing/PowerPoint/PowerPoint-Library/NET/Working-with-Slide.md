---
title: Create, read and edit PowerPoint slides in CSharp |
...
The 
Syncfusion<sup>&reg;</sup> PowerPoint library supports the following predefined slide layout types to create a slide as equivalent to Microsoft PowerPoint:
