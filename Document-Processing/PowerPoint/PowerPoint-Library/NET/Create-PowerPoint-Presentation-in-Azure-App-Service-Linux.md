...
Step 8: Include the below code snippet in **HomeController.cs** **to create a PowerPoint document**. 
...
![Click the Close button](Azure-Images/App-Service-Linux/Finish-Create-PowerPoint-Presentation.png)
