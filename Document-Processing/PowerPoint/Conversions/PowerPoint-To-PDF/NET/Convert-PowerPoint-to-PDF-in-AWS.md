...
<tr>
<td>
{{'[AWS Lambda](https://help.syncfusion.com/document-processing/powerpoint/conversions/powerpoint-to-pdf/net/convert-powerpoint-presentation-to-pdf-in-aws-lambda)' | markdownify}} <br/></td><td>
