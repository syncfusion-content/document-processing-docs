---
title: FAQ about multithreading in PowerPoint to PDF | Syncfusion<sup>®</sup>
...
Yes, the Syncfusion<sup>®</sup> PowerPoint library is thread-safe, and you can create multiple instances of the [Presentation](https://help.syncfusion.com/cr/document-processing/Syncfusion.Presentation.html) class to load the same file as multiple copies or different PowerPoint files, then convert them to PDF using multithreading in C#.
