---
title: .NET PowerPoint Framework - Convert PowerPoint to PDF |Syncfusion<sup>®</sup>
...
N> 3. **In .NET Core targeting applications**, metafile images such as EMF and WMF have some limitations. So, those images will not preserve in Presentation document to PDF conversion using Essential<sup>®</sup> Presentation. 
...
Essential<sup>®</sup> Presentation currently supports following PDF conformances while converting a PowerPoint document to PDF.
