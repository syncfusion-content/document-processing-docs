---
title: PowerPoint slides to Image conversion in UWP| Syncfusion<sup>®</sup>
...
PowerPoint slides can be converted to images in UWP by using Essential<sup>®</sup> Presentation library. The following assemblies are required in the UWP application to convert the slides as images.
