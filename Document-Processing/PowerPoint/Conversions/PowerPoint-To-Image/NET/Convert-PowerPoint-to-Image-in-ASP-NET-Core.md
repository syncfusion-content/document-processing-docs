...
![Select the Syncfusion.PresentationRenderer.Net.Core NuGet package](ASP-NET-Core_images/Select-Syncfusion.PresentationRenderer.Net.Core-NuGet.png)

* Click the Install button to complete the installation.

![Install the Syncfusion.PresentationRenderer.Net.Core NuGet package](ASP-NET-Core_images/Install-Syncfusion.PresentationRenderer.Net.Core-NuGet.png)
