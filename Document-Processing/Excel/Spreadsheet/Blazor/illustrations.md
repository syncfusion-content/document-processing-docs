...
* Corner resizing option in the image element. Currently, resizing images is supported through edge and corner handles, but certain advanced corner resizing options may have limitations.
* Copy and paste the external image. Direct copying and pasting of external images may have restrictions; use the Insert Image option for more reliable image insertion.