---
layout: post
title: Charts and Visualizations in Blazor Spreadsheet | Syncfusion
description: Learn about charts and visualizations in the Syncfusion Blazor Spreadsheet component, including chart creation, customization, and management.
...
By default, charts are enabled in the Spreadsheet (via the [AllowChart](https://help.syncfusion.com/cr/blazor/Syncfusion.Blazor.Spreadsheet.SfSpreadsheet.html#Syncfusion_Blazor_Spreadsheet_SfSpreadsheet_AllowChart) property). Once created, charts behave as objects within the worksheet—they can be moved, resized, and customized without affecting the underlying data.

## Overview of Chart and Visualization Operations

The Blazor Spreadsheet component provides a variety of features for working with charts and visualizations. Below is a quick overview of each feature, with links to their respective documentation sections:
