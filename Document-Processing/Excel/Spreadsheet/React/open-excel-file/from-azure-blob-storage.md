---
layout: post
title: Open Excel from Azure Blob Storage in React Spreadsheet | Syncfusion
description: Learn how to open Excel files stored in Azure Blob Storage using the Syncfusion React Spreadsheet control.
