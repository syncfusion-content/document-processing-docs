...
description: Learn how to set up and connect an ASP.NET Core Web API server for the AI Assist feature in the Syncfusion ASP.NET MVC Spreadsheet component.
