---
layout: post
title: ASP.NET MVC SpreadsheetEditor ASP.NET Core Redis Setup | Syncfusion
description: Learn how to configure the ASP.NET Core Collaboration Server and Redis for ASP.NET MVC SpreadsheetEditor collaborative editing.
