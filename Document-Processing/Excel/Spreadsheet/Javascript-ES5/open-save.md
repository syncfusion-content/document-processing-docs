---
layout: post
title: Open and Save in JavaScript Spreadsheet | Syncfusion
description: Open and save in JavaScript Spreadsheet enable users to import, edit, and export workbook data seamlessly across applications.
...
| ----- | ----- | ----- |
| file | FileList or string or File | Provides access to the file stream. `FileList` contains the length and item index. <br/> `File` specifies the file's `lastModified` value and file name. |
