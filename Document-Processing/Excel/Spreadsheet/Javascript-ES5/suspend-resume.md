...
description: Suspend and resume UI refresh in JavaScript Spreadsheet improve performance by batching multiple updates and reducing unnecessary rendering.
...
{% include code-snippet/spreadsheet/javascript-es5/suspend-resume-cs1/index.js %}
{% endhighlight %}
{% highlight html tabtitle="index.html" %}
{% include code-snippet/spreadsheet/javascript-es5/suspend-resume-cs1/index.html %}
{% endhighlight %}
{% endtabs %}

{% previewsample "/document-processing/code-snippet/spreadsheet/javascript-es5/suspend-resume-cs1" %}
