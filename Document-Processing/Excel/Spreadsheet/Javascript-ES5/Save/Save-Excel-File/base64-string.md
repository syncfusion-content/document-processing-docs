---
layout: post
title: Save to Base64 in EJ2 Javascript Spreadsheet control
description: Learn here all about how to Save an excel file to Base64 string data in Syncfusion EJ2 Javascript Spreadsheet control of Syncfusion Essential JS 2 and more.
