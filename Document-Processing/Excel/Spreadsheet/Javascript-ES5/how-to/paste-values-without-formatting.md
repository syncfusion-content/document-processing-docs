---
layout: post
title: Paste Without Formatting in EJ2 Javascript Spreadsheet component | Syncfusion
description: Learn here about Paste only values without formatting during copy and paste in Syncfusion EJ2 Javascript Spreadsheet component of Syncfusion Essential JS 2 and more.
control: Spreadsheet 
platform: document-processing
documentation: ug
---

# Paste Values Without Formatting and styles in EJ2 Javascript Spreadsheet
...
{% include code-snippet/spreadsheet/javascript-es5/paste-values-cs1/app/index.js %}
{% endhighlight %}
{% highlight ts tabtitle="index.html" %}
{% include code-snippet/spreadsheet/javascript-es5/paste-values-cs1/app/index.html %}
{% endhighlight %}
{% endtabs %}
