...
| [`Paste Special`](https://ej2.syncfusion.com/angular/documentation/api/spreadsheet#paste) | `Values` - Paste the data values from clipboard to spreadsheet.  `Formats` - Paste the data formats from  <br/> clipboard to spreadsheet. |
...
| [`Hyperlink`](https://ej2.syncfusion.com/angular/documentation/api/spreadsheet#hyperlink) | Create a link in the spreadsheet to navigate to web links or cell reference within the sheet or other sheets  <br/> in the Spreadsheet. |
