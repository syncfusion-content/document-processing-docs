...
description: AI Assist Web API server setup in Angular Spreadsheet explains how to configure and connect an ASP.NET Core Web API for AI-powered features.
...
builder.Services.AddCors(options =>
{
    options.AddPolicy("AllowSpecificOrigins", policy =>
        policy.WithOrigins("http://localhost:4200")   // your Angular dev origin
              .AllowAnyMethod()
              .AllowAnyHeader());
});
...
Once the server is listening, Configure the `requestUrl` inside [`aiAssistSettings`](https://ej2.syncfusion.com/angular/documentation/api/spreadsheet/index-default#aiassistsettings) to point to the server endpoint:
...
* [Live Demo](https://document.syncfusion.com/demos/spreadsheet-editor/angular/#/tailwind3/spreadsheet/ai-smart-spreadsheets)
