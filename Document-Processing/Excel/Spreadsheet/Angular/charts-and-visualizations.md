...
{% include code-snippet/spreadsheet/angular/insert-chart-cs1/src/app.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/spreadsheet/angular/insert-chart-cs1/src/main.ts %}
{% endhighlight %}
{% endtabs %}

{% previewsample "/document-processing/code-snippet/spreadsheet/angular/insert-chart-cs1" %}
...
{% previewsample "/document-processing/code-snippet/spreadsheet/angular/chart-cs3" %}
...
{% previewsample "/document-processing/code-snippet/spreadsheet/angular/delete-chart-cs1" %}
...
**See:** [insertChart API Documentation](https://ej2.syncfusion.com/angular/documentation/api/spreadsheet/index-default#insertchart)
...
**See:** [deleteChart API Documentation](https://ej2.syncfusion.com/angular/documentation/api/spreadsheet/index-default#deletechart)
...
**See:** [selectChart API Documentation](https://ej2.syncfusion.com/angular/documentation/api/spreadsheet/index-default#selectchart)

#### deselectChart()
Removes selection from the currently selected chart.

**See:** [deselectChart API Documentation](https://ej2.syncfusion.com/angular/documentation/api/spreadsheet/index-default#deselectchart)
...
**See:** [allowChart API Documentation](https://ej2.syncfusion.com/angular/documentation/api/spreadsheet/index-default#allowchart)
