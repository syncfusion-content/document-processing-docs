...
The different types of custom number formats populated in the custom number format dialog are,
...
The supported font formats in the Spreadsheet are font-family, font-size, bold, italic, strike-through, underline, and font color.
...
* Using the `border`, `borderLeft`, `borderRight`, and `borderBottom` properties, you can set the desired border to each cell at initial load.
...
* Selecting the border options from the **Home** tab in the ribbon toolbar.
...
{% tabs %}
{% highlight ts tabtitle="app.ts" %}
{% include code-snippet/spreadsheet/angular/text-overflow-cs1/src/app.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/spreadsheet/angular/text-overflow-cs1/src/main.ts %}
{% endhighlight %}
{% endtabs %}
  
{% previewsample "/document-processing/samples/spreadsheet/angular/text-overflow-cs1" %}
...
You can apply conditional formatting in one of the following ways:
...
Formula-based Conditional Formatting enables you to apply custom formatting rules using formulas through the `conditionalFormats` property in the sheet model or the [`conditionalFormat()`](https://ej2.syncfusion.com/angular/documentation/api/spreadsheet#conditionalformat) method.
...
Using the custom format for conditional formatting, you can set cell styles such as color, background color, font style, font weight, and underline.
...
You can clear the defined rules in one of the following ways:

* Using the **Clear Rules** option in the **Conditional Formatting** button on the **Home** tab in the ribbon to clear the rule from the selected cells.
...
In the **Syncfusion Angular Spreadsheet**, rich text formatting is supported through the [`richText`](https://ej2.syncfusion.com/angular/documentation/api/spreadsheet/index-default#richtext) property of the cell model.
...
3. You can also apply formatting dynamically using the [`updateCell`](https://ej2.syncfusion.com/angular/documentation/api/spreadsheet/index-default#updatecell) method.
