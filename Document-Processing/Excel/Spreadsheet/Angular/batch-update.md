...
created(){
    if(this.spreadsheetObj){
        ...
        this.spreadsheetObj.updateCell({ value: 'Total' }, 'A1');
        this.spreadsheetObj.updateCell({ value: '1200' }, 'B1');
        this.spreadsheetObj.cellFormat({ fontWeight: 'bold' }, 'A1:B1');
        this.spreadsheetObj.numberFormat('$#,##0.00', 'B1');
...
{% include code-snippet/spreadsheet/angular/batch-update/src/app.ts %}
{% endhighlight %}

{% highlight ts tabtitle="main.ts" %}
{% include code-snippet/spreadsheet/angular/batch-update/src/main.ts %}
{% endhighlight %}
{% endtabs %}

{% previewsample "/document-processing/code-snippet/spreadsheet/angular/batch-update" %}
