---
layout: post
title: Open Excel from AWS S3 in Vue Spreadsheet Control | Syncfusion
description: How to open an Excel file from AWS S3 in the Vue Spreadsheet control of Syncfusion Essential JS 2 and more details.
