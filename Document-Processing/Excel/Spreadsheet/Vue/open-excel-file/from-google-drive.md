---
layout: post
title: Open excel from Google Drive in Vue Spreadsheet control | Syncfusion
description: Learn about how to Open an Excel file from Google Drive in Vue Spreadsheet control of Syncfusion Essential JS 2.
...
**Step 2:** Create a Simple Spreadsheet Sample in Vue

Start by following the steps provided in this [link](https://help.syncfusion.com/document-processing/excel/spreadsheet/vue/getting-started) to create a simple Spreadsheet sample in Vue. This will give you a basic setup of the Spreadsheet component.
...
**Step 4:** Modify the index File in the Spreadsheet sample to make a fetch call to the server to retrieve and process the Excel file from the Google Drive and load the JSON result into the client-side spreadsheet using the [openFromJson](https://ej2.syncfusion.com/vue/documentation/api/spreadsheet/index-default#openfromjson) method.
