...
description: Learn how to deploy the Syncfusion Spreadsheet server Docker image to AWS EKS and connect it to the Vue Spreadsheet component.
...
**Step 5:** Configure the Vue client

Start by following the steps provided in this [link](../getting-started) to create a simple Spreadsheet sample in Vue. This will give you a basic setup of the Spreadsheet component. Once the Service reports an external address (e.g., a1b2c3d4e5f6-1234567890.us-east-1.elb.amazonaws.com), update the [`openUrl`](https://ej2.syncfusion.com/vue/documentation/api/spreadsheet/index-default#openurl) and [`saveUrl`](https://ej2.syncfusion.com/vue/documentation/api/spreadsheet/index-default#saveurl) properties of your Vue Spreadsheet component:
...
## See Also
* [Docker Image Overview in Vue Spreadsheet](./spreadsheet-server-docker-image-overview)
