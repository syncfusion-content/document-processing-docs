---
layout: post
title: Save excel to Google Drive in Vue Spreadsheet control | Syncfusion
description: Learn about how to Save an Excel file to Google Drive from Vue Spreadsheet control of Syncfusion Essential JS 2.
...
**Step 4:** Modify the index file in the Spreadsheet sample to save the Spreadsheet as JSON data using the [`saveAsJson`](https://ej2.syncfusion.com/vue/documentation/api/spreadsheet/index-default#saveasjson) method and send the saved JSON to the server via fetch call.
