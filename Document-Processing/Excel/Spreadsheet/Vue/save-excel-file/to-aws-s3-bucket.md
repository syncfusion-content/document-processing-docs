---
layout: post
title: Saving Excel to AWS S3 in Vue Spreadsheet control | Syncfusion
description: Learn how to save an Excel file to AWS S3 in the Vue Spreadsheet control of Syncfusion Essential JS 2.
