---
layout: post
title: Save excel to Google Cloud in Vue Spreadsheet control | Syncfusion
description: Learn about how to Save an Excel file from Google Cloud Storage in Vue Spreadsheet control of Syncfusion Essential JS 2.
...
**Step 1:** Create a Simple Spreadsheet Sample in Vue
...
**Step 3:**  Modify the index File in the Spreadsheet sample to using [`saveAsJson`](https://ej2.syncfusion.com/vue/documentation/api/spreadsheet/index-default#saveasjson) method to serialize the spreadsheet and send it to the back-end
