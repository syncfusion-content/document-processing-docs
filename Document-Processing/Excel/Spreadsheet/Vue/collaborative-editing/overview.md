...
Collaborative editing requires the Vue SpreadsheetEditor package, the `@syncfusion/ej2-collaborator` package, an ASP.NET Core Collaboration Server, Redis, WebSocket or SignalR communication, and a SpreadsheetEditor-specific server adapter.
