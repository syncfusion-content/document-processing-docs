---
layout: post
title: AI Assist Web API Server Setup in Vue Spreadsheet | Syncfusion
description: AI Assist Web API server setup in Vue Spreadsheet explains how to configure and connect an ASP.NET Core Web API for AI-powered features.
platform: document-processing
control: AI Assist Web API Server Setup
documentation: ug
---

# AI Assist Web API Server Setup in Vue Spreadsheet
...
builder.Services.AddCors(options =>
{
    options.AddPolicy("AllowSpecificOrigins", policy =>
        policy.WithOrigins("http://localhost:5173")   // your Vue dev origin
              .AllowAnyMethod()
              .AllowAnyHeader());
});
...
* [Live Demo](https://document.syncfusion.com/demos/spreadsheet-editor/vue/#/tailwind3/spreadsheet/ai-smart-spreadsheets)
