...
* **Programmatically** – Use the [`sort`](https://ej2.syncfusion.com/javascript/documentation/api/spreadsheet#sort) method.  
...
By default, sorting in the Spreadsheet is **case insensitive**. To perform sorting with case sensitivity, set the [`caseSensitive`](https://ej2.syncfusion.com/javascript/documentation/api/spreadsheet#casesensitive) property to `true` and pass it as part of the `sortOption` arguments in the `sort` method.  
