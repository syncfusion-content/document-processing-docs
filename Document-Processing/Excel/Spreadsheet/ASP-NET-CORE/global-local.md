---
layout: post
title: Globalization in ASP.NET Core Spreadsheet | Syncfusion
description: Learn about globalization in the Syncfusion ASP.NET Core Spreadsheet control, including localization, culture settings, and regional formats.
...
The [Localization](https://ej2.syncfusion.com/aspnetcore/documentation/common/localization) library allows you to localize the default text displayed by the Spreadsheet. Static text used by features such as cell formatting, merge cells, and data validation can be translated by defining the [locale](https://help.syncfusion.com/cr/aspnetcore-js2/Syncfusion.EJ2.Spreadsheet.Spreadsheet.html#Syncfusion_EJ2_Spreadsheet_Spreadsheet_Locale) property and loading the corresponding translation object.
