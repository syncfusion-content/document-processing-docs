...
The following table compares Excel functionality with the availability of EJ1 and EJ2 [ASP.NET Core Spreadsheet](https://www.syncfusion.com/spreadsheet-editor-sdk/asp-net-core-spreadsheet-editor) features.
