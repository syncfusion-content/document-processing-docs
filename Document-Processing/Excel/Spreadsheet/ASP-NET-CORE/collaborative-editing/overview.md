---
layout: post
title: Collaborative Editing in ASP.NET Core SpreadsheetEditor | Syncfusion
description: Learn how real-time collaborative editing synchronizes workbook changes, user presence, and selections in the ASP.NET Core SpreadsheetEditor.
control: Collaborative Editing
platform: document-processing
documentation: ug
---

# Collaborative editing in ASP.NET Core SpreadsheetEditor

The ASP.NET Core SpreadsheetEditor supports real-time collaborative editing, allowing multiple users to work on the same workbook and view synchronized changes, connected users, and selections. Supported workbook actions are synchronized through a collaboration service to maintain a consistent workbook state for users connected to the same room.
...
- The ASP.NET Core SpreadsheetEditor package.
...
### Client - ASP.NET Core SpreadsheetEditor
