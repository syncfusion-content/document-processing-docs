---
layout: post
title: AI Assist Integration in ASP.NET Core Spreadsheet control | Syncfusion
description: Learn how to set up and configure AI Assist in the Syncfusion ASP.NET Core Spreadsheet control for AI-powered features.
platform: document-processing
control: AI Assist
documentation: ug
---

# AI Assist Integration in ASP.NET Core Spreadsheet control

## Integration

AI Assist integrates seamlessly into your ASP.NET Core Spreadsheet application, enabling AI-powered capabilities with minimal configuration. This section covers the required setup.
...
<head>
    ...
    <link rel="stylesheet" href="https://cdn.syncfusion.com/ej2/{{ site.ej2version }}/ej2-notifications/styles/fluent.css" />
    <link rel="stylesheet" href="https://cdn.syncfusion.com/ej2/{{ site.ej2version }}/ej2-interactive-chat/styles/fluent.css" />
</head>
```
...
Inject the `AIAssist` module into the Spreadsheet using JavaScript. Add the following script after the Syncfusion script references in `~/Pages/Shared/_Layout.cshtml`.
...
```cshtml
<ejs-spreadsheet id="spreadsheet" enableAIAssist="true" promptRequest="onPromptRequest"
    openUrl="https://document.syncfusion.com/web-services/spreadsheet-editor/api/spreadsheet/open"
    saveUrl="https://document.syncfusion.com/web-services/spreadsheet-editor/api/spreadsheet/save">
...
```cshtml
<ejs-spreadsheet id="spreadsheet" enableAIAssist="true" promptResponse="onPromptResponse"
    openUrl="https://document.syncfusion.com/web-services/spreadsheet-editor/api/spreadsheet/open"
    saveUrl="https://document.syncfusion.com/web-services/spreadsheet-editor/api/spreadsheet/save">
    <e-spreadsheet-aiassistsettings requestUrl="https://localhost:{port}/api/AIAssist/Chat">
    </e-spreadsheet-aiassistsettings>
...
3. Verify CORS is enabled
    * Your ASP.NET Core application origin must be allowed in the AI server's CORS policy
