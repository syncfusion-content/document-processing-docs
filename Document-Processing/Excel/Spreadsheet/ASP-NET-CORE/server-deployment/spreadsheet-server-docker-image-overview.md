...
This Docker image is the pre-defined Docker container for ASP.NET Core Spreadsheet back-end functionalities. This server-side Web API project targets ASP.NET Core 8.0.
