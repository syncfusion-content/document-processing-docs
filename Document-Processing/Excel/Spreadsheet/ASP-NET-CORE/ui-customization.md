...
{% endhighlight %}
{% highlight c# tabtitle="customTabController.cs" %}
{% include code-snippet/spreadsheet/asp-net-core/custom-tab-and-item-cs1/customTabController.cs %}
{% endhighlight %}
{% endtabs %}
...
{% endhighlight %}
{% highlight c# tabtitle="addToolbarController.cs" %}
{% include code-snippet/spreadsheet/asp-net-core/add-toolbar-items-cs1/addToolbarController.cs %}
{% endhighlight %}
{% endtabs %}
...
{% endhighlight %}
{% highlight c# tabtitle="showOrHideRibbonController.cs" %}
{% include code-snippet/spreadsheet/asp-net-core/show-or-hide-ribbon-items-cs1/showOrHideRibbonController.cs %}
{% endhighlight %}
{% endtabs %}
...
{% endhighlight %}
{% highlight c# tabtitle="enableDisableRibbonController.cs" %}
{% include code-snippet/spreadsheet/asp-net-core/enable-or-disable-ribbon-items-cs1/enableDisableRibbonController.cs %}
{% endhighlight %}
{% endtabs %}
