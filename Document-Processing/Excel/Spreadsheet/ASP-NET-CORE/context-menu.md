---
layout: post
title: Context Menu in ASP.NET Core Spreadsheet | Syncfusion
description: Learn about the context menu in the Syncfusion ASP.NET Core Spreadsheet control, including customization and available menu actions.
