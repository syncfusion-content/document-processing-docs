...
* [Data sources](data-binding): Binds the Spreadsheet to an array of objects or data from a web service using `DataManager`.
...
* [Filtering](filter): Displays specific rows in the Spreadsheet by hiding the others.
