...
{% endhighlight %}
{% highlight c# tabtitle="DynamicCellTemplateController.cs" %}
{% include code-snippet/spreadsheet/asp-net-core/dynamic-cell-template-cs1/dynamicCellTemplateController.cs %}
{% endhighlight %}
{% endtabs %}
