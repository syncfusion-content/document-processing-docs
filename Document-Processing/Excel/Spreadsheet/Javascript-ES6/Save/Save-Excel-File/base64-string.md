---
layout: post
title: Save to Base64 in JavaScript (ES6) Spreadsheet Editor | Syncfusion
description: Learn here all about how to Save an excel file to Base64 string data in javascript(ES6) Spreadsheet editor of Syncfusion Essential JS 2 and more.
