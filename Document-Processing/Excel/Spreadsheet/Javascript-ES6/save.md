---
layout: post
title: Save in TypeScript Spreadsheet | Syncfusion
description: Save in TypeScript Spreadsheet enables users to export and store workbook data in supported file formats for future use.
