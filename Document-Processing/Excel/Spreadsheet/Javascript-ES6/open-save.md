---
layout: post
title: Open and Save in TypeScript Spreadsheet | Syncfusion
description: Open and save in TypeScript Spreadsheet enable users to import, edit, and export workbook data seamlessly across applications.
...
The Spreadsheet control opens an Excel document with its data, style, format, and more. To enable this feature, set [`allowOpen`](https://ej2.syncfusion.com/documentation/api/spreadsheet#allowopen) to `true` and assign a service URL to the [`openUrl`](https://ej2.syncfusion.com/documentation/api/spreadsheet#openurl) property.
