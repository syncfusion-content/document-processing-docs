...
In the active Spreadsheet, the sheet unprotection can be done in any of the following ways:
...
Protect workbook feature helps you to protect the workbook so that users cannot insert, delete, rename, hide, and unhide the sheets in the spreadsheet.
...
Unprotect Workbook is used to enable the insert, delete, rename, move, copy, hide, and unhide sheets feature  in the spreadsheet.
