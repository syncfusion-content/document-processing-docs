...
description: Add conditional format rules with the Syncfusion JavaScript Excel Library.
...
Create rules with `sheet.conditionalFormats.add(sqref)` and configure the returned `ConditionalFormat` handle.
