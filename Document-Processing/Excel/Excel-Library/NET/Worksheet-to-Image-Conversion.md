---
title: Worksheet to Image Conversion in .NET Excel Library | Syncfusion
description: Worksheet to image conversion in Syncfusion .NET Excel Library describes how to convert Excel worksheets into image files.
