...
description: The ASP.NET Core platform lets users create, read, and edit Excel files with Syncfusion XlsIO in web applications.
platform: document-processing
control: XlsIO
documentation: UG
---
# Excel Files in ASP.NET Core with Excel Library
