...
## Installing Syncfusion&reg; XlsIO through NuGet Packages 
...
N> 2. From the Essential Studio&reg; 2018 Volume 3 release(v16.3.0.21), Syncfusion has changed some of the NuGet package names to search and find the required Syncfusion NuGet packages in nuget.org easily based on the control and its platforms.

N> 3. Starting with v17.3.0.x, Syncfusion&reg; provides support to .NET Core 3.0. You can use the above WPF or Windows Forms platform NuGet packages for .NET Core 3.0 targeting applications and use the same “C# tab” code examples for it.
...
N> Syncfusion&reg; components are available in nuget.org
