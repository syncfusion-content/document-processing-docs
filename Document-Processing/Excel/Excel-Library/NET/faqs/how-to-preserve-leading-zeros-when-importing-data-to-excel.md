---
title: How to Preserve Leading Zeros in .NET Excel Library | Syncfusion
description: Keep leading zeros in text when importing a DataTable to Excel using the .NET Excel Library during DataTable import.
