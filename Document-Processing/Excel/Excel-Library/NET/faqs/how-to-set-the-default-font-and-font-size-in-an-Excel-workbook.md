---
title: How to Set Default Fonts in .NET Excel Library | Syncfusion
description: Set the default font and font size in an Excel workbook using the Syncfusion .NET Excel Library for workbook formatting.
