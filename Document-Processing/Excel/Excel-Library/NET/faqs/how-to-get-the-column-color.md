...
description: This page explains how to get the styled column color when column cells have different colors in an Excel document using .NET Excel library (XlsIO).
