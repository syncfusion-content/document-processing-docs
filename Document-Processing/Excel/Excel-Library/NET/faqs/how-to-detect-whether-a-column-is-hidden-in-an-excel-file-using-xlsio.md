...
description: Shows how to detect whether a column is hidden in an Excel and also shows how to check the ColumnInformation IsHidden property in a worksheet using Syncfusion XlsIO.
