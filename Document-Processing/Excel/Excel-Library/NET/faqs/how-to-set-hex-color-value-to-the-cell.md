...
description: Learn how to apply a hex color to an Excel cell with the .NET Excel library (XlsIO). Convert a hex string to RGB and assign it to CellStyle.Color. 
