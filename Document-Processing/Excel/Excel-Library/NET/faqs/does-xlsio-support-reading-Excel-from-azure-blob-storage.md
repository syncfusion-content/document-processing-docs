...
description: Azure Blob Storage access explains whether Syncfusion .NET Excel Library can read Excel files directly from Azure Blob Storage streams.
...
For implementation details, please refer to <a href="https://help.syncfusion.com/document-processing/excel/excel-library/net/loading-and-saving/loading-and-saving-excel-files-in-azure-cloud-storage" aria-label="Documentation Reference  link">Loading and saving Excel document in Azure Cloud Storage</a>.
