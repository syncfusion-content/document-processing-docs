...
description: This page provides information about the maximum character count in an Excel cell in the .NET Excel library.
platform: document-processing
control: XlsIO
documentation: UG
---

# What is the maximum number of characters in an Excel cell?
