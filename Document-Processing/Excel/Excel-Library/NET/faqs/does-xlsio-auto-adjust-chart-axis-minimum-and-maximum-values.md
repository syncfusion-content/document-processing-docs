...
For details on setting chart axis minimum and maximum values in XlsIO, see the <a href="https://help.syncfusion.com/document-processing/excel/excel-library/net/charts/chart-axis#axis-settings" aria-label="Documentation Reference  link">Chart Axis Settings</a>.
