...
description: Explains how to create, read, and edit Excel documents in .NET MAUI applications using .NET Excel Library.
...
Add the new class file with name **PreviewControllerDS** file under **Project-> Platforms-> iOS** directory.
...
Add the new class file with name **QLPreviewItemFileSystem** file under **Project-> Platforms-> iOS** directory.
