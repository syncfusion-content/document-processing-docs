...
description: Download the Syncfusion Excel offline installer from the Syncfusion website with a valid license for setup.
...
6. Click the More Download Options (element 2 in the above screenshot) button to get the Essential&reg; Studio&reg; Excel Offline trial installer which is available in EXE and ZIP format.
