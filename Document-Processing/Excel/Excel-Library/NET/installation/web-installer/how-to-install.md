...
description: Syncfusion Excel web installer installation section explains how to install the web installer after downloading it from the Syncfusion website.
...
2. 	The Syncfusion&reg; Excel Web Installer's welcome wizard will be displayed. Click the Next button.
...
Syncfusion&reg; Excel installer can be uninstalled in two ways.

   * Uninstall the Excel using the Syncfusion&reg; Excel web installer
...
**Option 1: Uninstall the Excel using the Syncfusion&reg; Excel web installer**
...
1.  The Syncfusion&reg; Excel Web Installer's welcome wizard will be displayed. Click the Next button
