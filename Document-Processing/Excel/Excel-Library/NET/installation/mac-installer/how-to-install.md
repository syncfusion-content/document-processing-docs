...
description: Install the Syncfusion Excel Mac installer after downloading it from the Syncfusion website for setup.
...
## Steps to resolve the warning message in Catalina OS or later
   ...
   While running Essential Studio&reg; Excel Mac Installers on Catalina MacOS or later, the below alert will be displayed.
...
The steps below show how to install Essential Studio&reg; Excel Mac installer.
...
After the installation, the license key is required to register the demo source that is included in the Mac installer. To learn about the steps for license registration for the ASP.NET Core - EJ2 samples in the Essential Studio&reg; Excel Mac installer, please refer to this.
