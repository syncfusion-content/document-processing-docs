...
description: UWP applications let users create, read, and edit Excel files using Syncfusion Excel Library for application development.
platform: document-processing
control: XlsIO
documentation: UG
---
# Excel Files in UWP with Excel Library
