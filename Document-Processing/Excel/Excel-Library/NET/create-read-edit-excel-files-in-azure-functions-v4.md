...
description: The Azure Functions v4 platform lets users create, read, and edit Excel documents with Syncfusion XlsIO.
platform: document-processing
control: XlsIO
documentation: UG
---
# Excel Files in Azure Functions v4 with Excel Library
