...
description: The Azure App Service on Linux platform lets users create, read, and edit Excel files with Syncfusion XlsIO.
platform: document-processing
control: XlsIO
documentation: UG
---
# Excel Files in Azure App Service Linux with Excel Library
