...
description: The console application platform lets users create Excel files with Syncfusion Excel XlsIO library in C# applications.
platform: document-processing
control: XlsIO
documentation: UG
---
# Excel Files in Console Applications with Excel Library
...
Step 1: Create a new C# Console Application project using Create .NET Project option.

![Create console application in Visual Studio](Console-Apps-images/Console-Apps-VS_images_img1.png)
...
![Install Syncfusion.XlsIO.Net.Core Nuget Package](Console-Apps-images/Console-Apps-VS_images_img3.png)
...
![Install Syncfusion.XlsIO.WinForms Nuget Package](Console-Apps-images/Console-Apps-VS_images_img3.png)
