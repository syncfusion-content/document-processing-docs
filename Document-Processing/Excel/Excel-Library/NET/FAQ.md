...
* [How to protect the zip files and their items using Syncfusion.Compression.Base?](faqs/how-to-protect-the-zip-file-and-their-items-with-different-password)