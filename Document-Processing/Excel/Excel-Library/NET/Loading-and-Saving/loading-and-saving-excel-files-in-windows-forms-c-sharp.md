...
* Install the [Syncfusion.XlsIO.WinForms](https://www.nuget.org/packages/Syncfusion.XlsIO.WinForms) NuGet package in your Windows Forms project.
...
Include the following namespace in your `Form1.cs` (or `Form1.vb`) file.
...
* [Create, read, and edit Excel files in Windows Forms](https://help.syncfusion.com/document-processing/excel/excel-library/net/create-read-edit-excel-files-in-windows-forms-c-sharp)
