---
title: Loading and Saving Excel in AWS Excel Library | Syncfusion
description: AWS Excel file handling explains how to load and save Excel documents using Syncfusion .NET Core Excel Library in C#.
platform: document-processing
control: XlsIO
documentation: UG
---

# Loading and Saving Files in AWS Excel Library
