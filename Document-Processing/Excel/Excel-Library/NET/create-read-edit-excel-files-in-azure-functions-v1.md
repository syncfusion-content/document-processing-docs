...
description: The Azure Functions v1 platform lets users create, read, and edit Excel files with Syncfusion XlsIO.
platform: document-processing
control: XlsIO
documentation: UG
---
# Excel Files in Azure Functions v1 with Excel Library
