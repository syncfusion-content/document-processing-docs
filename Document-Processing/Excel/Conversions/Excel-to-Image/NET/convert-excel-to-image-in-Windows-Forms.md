---
title: Excel to Image in Windows Forms Excel Library | Syncfusion
description: Windows Forms Excel to image conversion describes how to convert Excel documents to images using the .NET Excel Library.
platform: document-processing
control: XlsIO
documentation: UG
---

# Excel to Image Conversion in Windows Forms Excel Library
