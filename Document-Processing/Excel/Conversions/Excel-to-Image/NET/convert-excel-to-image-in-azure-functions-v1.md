---
title: Excel to Image in Azure Functions v1 Excel Library | Syncfusion
description: Azure Functions v1 Excel to image conversion describes how to convert Excel files to images without Microsoft Excel.
platform: document-processing
control: XlsIO
documentation: UG
---

# Excel to Image Conversion in Azure Functions v1 Excel Library
