---
title: Excel to PDF conversion in Microsoft Azure | Syncfusion
description: Azure Excel to PDF section explains how to convert Excel documents to PDF in Azure using the Syncfusion .NET Excel Library.
platform: document-processing
control: XlsIO
documentation: UG
---

# Excel to PDF Conversion in Azure using Excel Library
...
{{'[SkiaSharp.NativeAssets.Linux v4.150.1](https://www.nuget.org/packages/SkiaSharp.NativeAssets.Linux/4.150.1)' | markdownify}}<br/>{{'[HarfBuzzSharp.NativeAssets.Linux v2.8.2.2](https://www.nuget.org/packages/HarfBuzzSharp.NativeAssets.Linux/2.8.2.2)' |markdownify}} <br/></td></tr>
<tr>
<td>
Azure Functions v1
 <br/></td><td>
