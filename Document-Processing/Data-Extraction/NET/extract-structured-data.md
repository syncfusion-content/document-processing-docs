...
N>If you want to convert an image instead of a PDF, just replace the input stream with the image file (for example, Input.jpg, Input.png). The rest of the code remains the same.
