...
6. Click the More Download Options (element 2 in the above screenshot) button to get the Essential Studio<sup>&reg;</sup> Document SDK Offline trial installer which is available in EXE and ZIP format.
