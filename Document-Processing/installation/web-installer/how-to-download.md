---
layout: post
title: Downloading Syncfusion Document Solution web installer - Syncfusion
description: Learn here about how to download the Syncfusion Document Solution web installer from our Syncfusion website with a license.
...
# Downloading Syncfusion<sup>&reg;</sup> Document Solution Web Installer
...
2. After completing the required form or logging in with your registered Syncfusion<sup>&reg;</sup> account, you can download the Document Solution trial installer from the confirmation page. (as shown in the screenshot below.)
...
4. After downloading, the Syncfusion<sup>&reg;</sup> Document Solution trial installer can be unlocked using either the trial unlock key or the Syncfusion<sup>&reg;</sup> registered login credential. More information on generating an unlock key can be found in [this](https://www.syncfusion.com/kb/8069/how-to-generate-unlock-key-for-essentials-studio-products) article.
...
6. Click the Download (element 1 in the screenshot below) button to get the Syncfusion<sup>&reg;</sup> Essential Studio Document Solution web installer.
...
8. After downloading, the Syncfusion<sup>&reg;</sup> Document Solution web installer can be unlocked using the Syncfusion<sup>&reg;</sup> registered login credentials.
...
You can also refer to the [**Web installer**](https://help.syncfusion.com/document-processing/installation/web-installer/how-to-install) link for step-by-step installation guidelines.	