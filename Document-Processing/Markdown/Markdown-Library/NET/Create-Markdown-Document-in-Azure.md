...
<tr>
<td>
{{'[Azure Functions (Flex Consumption)](https://help.syncfusion.com/document-processing/markdown/markdown-library/net/create-markdown-document-in-azure-functions-flex-consumption)' | markdownify}}<br/></td><td>
{{'[Syncfusion.Markdown](https://www.nuget.org/packages/Syncfusion.Markdown)' | markdownify}}<br/></td></tr>
</table>
