---
title: Create Markdown document in Azure App Service on Linux | Syncfusion
description: Create Markdown document in Azure App Service on Linux using .NET Core Markdown library without external dependencies. 
...
![Configure your new project](Azure-Images/App-Service-Linux/Configure_Your_Project_Markdown.png)
...
![Create Markdown document in Azure App Service on Linux](GettingStarted_images/GettingStarted_Output1.png)
