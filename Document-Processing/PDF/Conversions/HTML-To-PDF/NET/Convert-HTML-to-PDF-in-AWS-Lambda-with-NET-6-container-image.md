---
title: HTML to PDF in AWS Lambda .NET 6 Container PDF Library | Syncfusion
description: Learn how to convert HTML to PDF in AWS Lambda with NET 6 container image using Syncfusion .NET HTML converter Library.
