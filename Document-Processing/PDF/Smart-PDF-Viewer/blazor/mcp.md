---
layout: post
title: Syncfusion Blazor Smart PDF Viewer MCP Server Setup | Syncfusion
description: Discover the MCP server's advantages, installation requirements, and integration guidance for Blazor Smart PDF Viewer.
platform: document-processing
control: SfSmartPdfViewer
documentation: ug
---

# Syncfusion Blazor Smart PDF Viewer MCP Server

Syncfusion<sup style="font-size:70%">&reg;</sup> Blazor Smart PDF Viewer MCP Server accelerates Blazor Smart PDF Viewer application development by providing deep knowledge directly in your AI-powered IDE. [Model Context Protocol](https://modelcontextprotocol.io/docs/2026-07-28/getting-started/intro) (MCP) integration enables quick access to documentation, API references, and code-generation features from within the development environment.

These tools speed up development and reinforce best practices for the AI-powered Blazor Smart PDF Viewer integration, including Document Summarization with Q&A, Smart Redaction, and Smart Fill.
...
- **Expert Smart PDF Viewer Knowledge** - Deep understanding of the Blazor Smart PDF Viewer component (SfSmartPdfViewer) and its AI-powered implementation patterns.
...
- A **Blazor application** (existing or new); see [Blazor Smart PDF Viewer documentation](./overview)
...
The examples below showcase how the `search_docs` tool handles real-world Blazor Smart PDF Viewer development scenarios. The tool can be invoked directly, as shown in the examples below, for specific needs. Alternatively, an AI assistant can automatically invoke it based on the request.

**Get Started**

Use `search_docs` to get contextual guidance, code snippets, and configuration examples for the Blazor Smart PDF Viewer component.

{% promptcards %}
{% promptcard Component Configuration %}
#search_docs How do I configure the Syncfusion Blazor Smart PDF Viewer component?
{% endpromptcard %}
{% endpromptcards %}

**Implement Features**

Get step-by-step help for adding the AI-powered features of the Blazor Smart PDF Viewer.

{% promptcards %}
{% promptcard Summarize with Streaming %}
#search_docs How can I enable Summarize feature and StreamResponse in the Blazor Smart PDF Viewer?
{% endpromptcard %}
{% endpromptcards %}

{% promptcards %}
{% promptcard Smart Redaction %}
#search_docs How can I enable Smart Redaction feature and modify the redaction patterns in the Blazor Smart PDF Viewer?
{% endpromptcard %}
{% endpromptcards %}

{% promptcards %}
{% promptcard Smart Fill %}
#search_docs How can I enable Smart Fill feature in the Blazor Smart PDF Viewer?
{% endpromptcard %}
{% endpromptcards %}

**Localization & Customization**

Tailor the Blazor Smart PDF Viewer to support right-to-left layouts and custom AI service providers.

{% promptcards %}
{% promptcard RTL Support %}
#search_docs How to change the RTL for the Blazor Smart PDF Viewer?
{% endpromptcard %}
{% endpromptcards %}

{% promptcards %}
{% promptcard Custom AI Service with User Token %}
#search_docs How to use user token with Custom AI service in Blazor Smart PDF Viewer?
{% endpromptcard %}
{% endpromptcards %}

## Best Practices

To get the most out of the Syncfusion<sup style="font-size:70%">&reg;</sup> Blazor Smart PDF Viewer MCP Server:

- **Be Specific** - Include the component and AI feature in your queries (for example, *"Enable Smart Redaction with custom patterns in the Blazor Smart PDF Viewer"*).
- **Provide Context** - Include applicable versions, expected outcomes, AI service details, and any requirements or limitations that may affect the request.
...
- **For Troubleshooting** - Use AI suggestions for common issues; consult the [official documentation](./overview) or [support](https://support.syncfusion.com/support/tickets/create) for complex problems.
...
| **AI service not responding** | Confirm the configured AI service (Syncfusion<sup style="font-size:70%">&reg;</sup> AI, Azure OpenAI, or Custom AI) credentials, endpoint, and user token are valid. |
