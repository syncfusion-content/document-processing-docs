...
{% doccard text="Blazor (Classic)" link="/document-processing/pdf/pdf-viewer/blazor-classic/getting-started/server-side-application" icon="/document-processing/pdf/pdf-viewer/blazor-classic/getting-started/gettingstarted-images/Blazor (Classic).svg" %}
