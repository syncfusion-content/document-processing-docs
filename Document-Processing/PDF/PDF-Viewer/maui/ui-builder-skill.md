...
Integrated with your AI-powered IDE, it uses deep knowledge of **Syncfusion® PDF Viewer and other MAUI components** to deliver accurate and ready-to-use code.
...
### Component usage and API accuracy
...
**Note:** For Syncfusion® Code Studio, users must explicitly configure the agent location to use it in the chat. Refer to the [documentation](https://help.syncfusion.com/code-studio/reference/configure-properties/usersettings#agent-file-locations).
...
4. **Theming & Design System**  
   ...
   - Design system (Material Design 3, or Custom theme). If no themes are detected in the existing project, Material Design 3 is shown as the default option. You can proceed with this or change the theme as preferred.
...
**Note:** The assistant handles most stages automatically and may request confirmation where required.
...
- **Use advanced AI models:** For best results, use **Claude Sonnet 4.6 or a higher-capability model** to produce better code quality and more accurate implementations.
