...
This section briefly explains about how to integrate [Blazor PDF Viewer]() component in your Blazor Server App using Visual Studio and deploy it on AWS Elastic Beanstalk.
