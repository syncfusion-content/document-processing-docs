---
layout: post
title: Active Viewport Rendering | Syncfusion JavaScript (ES6) PDF Viewer
description: Learn how Active Viewport Rendering optimizes large-document zooming in the JavaScript (ES6) PDF Viewer.
...
# Active Viewport Rendering in JavaScript (ES6) PDF Viewer

Active Viewport Rendering is a rendering optimization feature in the JavaScript (ES6) PDF Viewer that improves zooming performance for large PDF pages.
...
- [Load PDF documents dynamically](./load-document)
- [How to disable tile rendering in PDF Viewer?](./disable-tile-rendering)
- [About how to section of JavaScript (ES6) PDF Viewer](../how-to-overview)
