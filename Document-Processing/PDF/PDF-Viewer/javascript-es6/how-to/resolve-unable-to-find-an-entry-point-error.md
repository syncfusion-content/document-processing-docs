---
layout: post
title: Fix Entry Point Resolution Issues in the Syncfusion PDF Viewer
description: Learn how to resolve the “unable to find an entry point” error after upgrading the Pdfium package in the Syncfusion JavaScript ES6 PDF Viewer.
