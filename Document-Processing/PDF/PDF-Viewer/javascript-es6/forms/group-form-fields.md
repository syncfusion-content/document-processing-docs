---
layout: post
title: Group Form Fields in JavaScript (ES6) PDF Viewer | Syncfusion
description: Group PDF form fields in the JavaScript (ES6) PDF Viewer by assigning the same name to multiple widgets so they behave as a single field group.
...
![Grouping textboxes using the same name property](../images/groupTextFileds.png)

![Grouping radio buttons using the same name property](../images/groupRadiobutton.png)
