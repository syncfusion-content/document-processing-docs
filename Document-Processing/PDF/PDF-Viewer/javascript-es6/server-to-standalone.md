---
layout: post
title: Migrate from Server-backed to Standalone TypeScript PDF Viewer | Syncfusion
...
**API Compatibility:**
- **No API Breaks:** There are no API breaks from server-backed to standalone PDF Viewer migration. All the APIs used in server-backed mode except [serviceUrl](https://ej2.syncfusion.com/documentation/api/pdfviewer/index-default#serviceurl), [ajaxRequestSettings](https://ej2.syncfusion.com/documentation/api/pdfviewer/index-default#ajaxrequestsettings), [retryCount](https://ej2.syncfusion.com/documentation/api/pdfviewer/index-default#retrycount), [retryTimeout](https://ej2.syncfusion.com/documentation/api/pdfviewer/index-default#retrytimeout), and [retryStatusCodes](https://ej2.syncfusion.com/documentation/api/pdfviewer/index-default#retrystatuscodes) are the same in standalone mode.
