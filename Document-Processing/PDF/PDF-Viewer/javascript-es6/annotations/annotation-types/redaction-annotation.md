...
description: Add, edit, delete, and apply redaction annotations in the JavaScript (ES6) PDF Viewer to permanently remove sensitive content from a PDF.
...
# Redaction Annotation in JavaScript (ES6) PDF Viewer
