...
{% previewsample "page.domainurl/code-snippet/pdfviewer/javascript/text-markup-annotation/highlight-mode-cs1" %}
...
{% previewsample "page.domainurl/code-snippet/pdfviewer/javascript/text-markup-annotation/highlight-normal-mode-cs1" %}
...
{% previewsample "page.domainurl/code-snippet/pdfviewer/javascript/text-markup-annotation/underline-mode-cs1" %}
...
{% previewsample "page.domainurl/code-snippet/pdfviewer/javascript/text-markup-annotation/underline-normal-mode-cs1" %}
...
{% previewsample "page.domainurl/code-snippet/pdfviewer/javascript/text-markup-annotation/strikethrough-mode-cs1" %}
...
{% previewsample "page.domainurl/code-snippet/pdfviewer/javascript/text-markup-annotation/strikethrough-normal-mode-cs1" %}
...
{% previewsample "page.domainurl/code-snippet/pdfviewer/javascript/text-markup-annotation/squiggly-mode-cs1" %}
...
{% previewsample "page.domainurl/code-snippet/pdfviewer/javascript/text-markup-annotation/squiggly-normal-mode-cs1" %}
...
{% previewsample "page.domainurl/code-snippet/pdfviewer/javascript/text-markup-annotation/undo-redo-cs1" %}
