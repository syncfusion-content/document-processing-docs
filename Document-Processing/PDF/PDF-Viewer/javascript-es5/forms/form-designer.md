...
description: Learn here all about form designer and toolbar in the JavaScript PDF Viewer component and more.
...
You can customize the Form Designer toolbar by specifying the tools to display and arranging them in the required order using the [FormDesignerToolbarItems](https://ej2.syncfusion.com/javascript/documentation/api/pdfviewer/formdesignertoolbaritem) property.
