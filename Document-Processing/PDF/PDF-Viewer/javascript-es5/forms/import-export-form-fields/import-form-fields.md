---
layout: post
title: Import Form Fields in JavaScript (ES5) PDF Viewer | Syncfusion
description: Import PDF form field data into the JavaScript (ES5) PDF Viewer from FDF, XFDF, and JSON sources, or directly from a JavaScript object.
