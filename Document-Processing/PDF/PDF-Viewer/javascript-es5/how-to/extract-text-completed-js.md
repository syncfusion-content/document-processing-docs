...
description: Use the extractTextCompleted event and isExtractText property in the JavaScript (ES5) PDF Viewer to extract text and bounds from a loaded PDF.
