...
description: Enable or disable text selection in the JavaScript (ES5) PDF Viewer using the enableTextSelection property to control how users interact with PDF text.
...
# How to Enable or Disable Text Selection in JavaScript (ES5) PDF Viewer
