...
description: Learn how to use the extractText method in the JavaScript PDF Viewer to extract text and bounds from one or more pages.
...
### Usage of extractText in Javascript PDF Viewer control
