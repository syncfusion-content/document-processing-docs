...
description: Learn how to retrieve the Base64 value of a loaded PDF in the JavaScript PDF Viewer using saveAsBlob and FileReader.
...
This guide shows how to obtain the Base64-encoded value of a PDF document loaded in the JavaScript PDF Viewer using JavaScript. Producing a Base64 string is useful for sending the PDF to a server, embedding it in JSON payloads, or client-side processing.
...
By implementing these steps in the JavaScript component, a PDF document loaded in the JavaScript PDF Viewer can be converted into a Base64-encoded data URL when a button is clicked. This facilitates the manipulation or transfer of PDF data as needed
