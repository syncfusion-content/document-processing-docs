...
description: Resolve rendering failures in Syncfusion JavaScript PDF Viewer v23.1+ by calling dataBind method before load and validating URLs, CORS, and CSP.
platform: document-processing
control: PDF Viewer
documentation: ug
---

# Document Loading Issues in Version 23.1 or Newer in JS
...
5. Upgrade to the latest viewer release; the issue may be fixed in newer versions.
6. Configure CORS correctly for cross-origin documents so the viewer can retrieve remote files.
7. Review Content Security Policy (CSP) settings and permit any external resources required by the viewer. See the Content Security Policy troubleshooting guide in the Syncfusion documentation for details.
