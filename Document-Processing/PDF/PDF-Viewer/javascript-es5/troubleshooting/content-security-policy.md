...
The resulting meta tag must be placed within the `<head>` element to resolve CSP violations when using the Javascript PDF Viewer control with the material and tailwind themes.
