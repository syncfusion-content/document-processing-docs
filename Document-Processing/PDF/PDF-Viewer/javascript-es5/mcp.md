---
layout: post
title: Syncfusion JavaScript PDF Viewer MCP Server Setup | Syncfusion
description: Discover the MCP server's advantages, installation requirements, and integration guidance for JavaScript PDF Viewer.
...
- **Expert PDF Viewer Knowledge** - Deep understanding of the JavaScript PDF Viewer component (SfPdfViewer) and its implementation patterns.
...
- A **JavaScript application** (existing or new); see [JavaScript PDF Viewer documentation](./getting-started)
...
The examples below showcase how the `search_docs` tool handles real-world JavaScript PDF Viewer development scenarios. The tool can be invoked directly, as shown in the examples below, for specific needs. Alternatively, an AI assistant can automatically invoke it based on the request.

**Get Started**

Use `search_docs` to get contextual guidance, code snippets, and configuration examples for the JavaScript PDF Viewer component.
...
Get step-by-step help for adding specific features to the JavaScript PDF Viewer.
...
To get the most out of the Syncfusion<sup style="font-size:70%">&reg;</sup> JavaScript PDF Viewer MCP Server:

- **Be Specific** - Include the component and use case in your queries (for example, *"Load a PDF from a remote URL into the JavaScript PDF Viewer and enable annotation export"*).
