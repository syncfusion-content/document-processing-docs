...
N> Starting with the 2026 Vol 2 main release (June 2026), no new features will be added to the Server PDF Viewer. This is because almost all PDF Viewer functionalities are now available in the Standalone PDF Viewer. If you are currently using the server-backed PDF Viewer, please refer to the [migration documentation](./server-to-standalone) to transition to the Standalone PDF Viewer.
