...
description: Learn how to save PDF files to Azure Blob Storage using the JavaScript PDF Viewer component in standalone and server-backed configurations.
