...
description: Learn how to load and save PDF files with Azure Active Directory (AAD) using the JavaScript PDF Viewer component and a server-backed web service.
