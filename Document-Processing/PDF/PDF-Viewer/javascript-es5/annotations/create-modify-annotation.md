...
description: Learn how to create and modify annotations in JavaScript PDF Viewer with UI and programmatic examples, plus quick links to all annotation types.
