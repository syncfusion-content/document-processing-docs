---
layout: post
title: Annotation Comment Filter in JavaScript (ES5) PDF Viewer | Syncfusion
description: Filter comments and annotations in the JavaScript (ES5) PDF Viewer by author, status, type, and date using the comment filter panel and programmatic APIs.
...
# Annotation Comment Filter in JavaScript (ES5) PDF Viewer
...
- [Annotation Permissions](../annotations/annotation-permission)
