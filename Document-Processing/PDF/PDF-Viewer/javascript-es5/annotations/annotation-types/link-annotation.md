...
The PDF Viewer raises annotation lifecycle events that can be used to detect when link annotations are added, modified, selected, or removed. See [Annotation Events](../annotation-event).
