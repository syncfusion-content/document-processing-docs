...
In [WPF PDF Viewer](https://www.syncfusion.com/pdf-viewer-sdk/wpf-pdf-viewer), text can be selected by clicking the mouse left button and dragging the mouse pointer over the text in any direction.
