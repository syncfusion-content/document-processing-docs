...
description: Learn how to save PDF files to Google Cloud Storage in the Syncfusion Angular PDF Viewer component of Essential JS 2.
...
To save a PDF file to Google Cloud Storage, follow these steps:
...
5. Modify the `Download()` method to save the downloaded PDF files to a Google Cloud Storage bucket.
