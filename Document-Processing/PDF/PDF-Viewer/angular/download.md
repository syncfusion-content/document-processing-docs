...
The PDF Viewer supports downloading the loaded PDF file. Download can be enabled or disabled using the following code snippet.
...
![Download option in PDF Viewer](images/download.png)
