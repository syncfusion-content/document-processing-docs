...
description: Learn how to create and modify annotations in Angular PDF Viewer with UI and programmatic examples, plus quick links to all annotation types.
