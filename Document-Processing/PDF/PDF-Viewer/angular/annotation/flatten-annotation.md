---
layout: post
title: Flatten Annotations in the Angular PDF Viewer
description: Learn how all about how to flatten annotations and formfields before saving a PDF in the Angular PDF Viewer.
