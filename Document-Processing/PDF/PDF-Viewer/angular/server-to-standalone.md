---
layout: post
title: Migrate from Server-backed to Standalone Angular PDF Viewer | Syncfusion
...
In your existing server-backed Angular component, locate the `serviceUrl` property. This property points to your server PDF Viewer web service.

### Step 2: Remove the `serviceUrl` Property

Remove or delete the [serviceUrl](https://ej2.syncfusion.com/angular/documentation/api/pdfviewer/index-default#serviceurl) property that references your server service.
...
Add the [resourceUrl](https://ej2.syncfusion.com/angular/documentation/api/pdfviewer/index-default#resouceurl) property to point to the PDFium resource files. You can choose between two approaches: CDN hosting (recommended for quick migration) or local hosting.
...
import { PdfViewerModule, ToolbarService, NavigationService,
         MagnificationService, TextSearchService } from '@syncfusion/ej2-angular-pdfviewer';
...
@Component({
  ...
  imports: [PdfViewerModule],
  providers: [ToolbarService, NavigationService, MagnificationService, TextSearchService]
})
export class CdnConfigComponent implements OnInit {
  public document: string = 'https://cdn.syncfusion.com/content/pdf/pdf-succinctly.pdf';
  public resource: string = "https://cdn.syncfusion.com/ej2/33.2.13/dist/ej2-pdfviewer-lib";
  
  ngOnInit(): void {
    console.log('Standalone CDN-based PDF Viewer initialized');
  }
}
{% endhighlight %}
{% endtabs %}
...
1. Copy the PDFium resource files to your `src/assets` folder
...
import { Component, OnInit } from '@angular/core';
import { PdfViewerModule, ToolbarService, NavigationService,
         MagnificationService, ThumbnailViewService, TextSearchService,
         PrintService, AnnotationService } from '@syncfusion/ej2-angular-pdfviewer';
...
@Component({
  ...
  imports: [PdfViewerModule],
  providers: [ToolbarService, NavigationService, MagnificationService,
              ThumbnailViewService, TextSearchService, PrintService, AnnotationService]
})
export class LocalResourcesComponent implements OnInit {
  public document: string = window.location.origin + "/assets/sample-pdf.pdf";
  public resource: string = window.location.origin + "/assets/ej2-pdfviewer-lib";
  
  ngOnInit(): void {
    console.log('Local resources configured for PDF Viewer');
  }
}
{% endhighlight %}
{% endtabs %}
...
@Component({
  ...
  template: `
    <ejs-pdfviewer 
       id="pdfViewer"
      [documentPath]="https://api.example.com/documents/report.pdf"
...
**Getting Started:**
- [Getting Started with Standalone Angular PDF Viewer](./getting-started) — Learn the fundamentals of standalone mode setup and configuration
...
- [PDF Viewer API Methods](https://ej2.syncfusion.com/angular/documentation/api/pdfviewer/index-default) — Reference all available API methods and properties

**Related Topics:**
- [System Requirements](https://ej2.syncfusion.com/angular/documentation/system-requirement)
- [Getting Started with Standalone Angular PDF Viewer](./getting-started)
