...
description: Learn about the Syncfusion Angular PDF Viewer, its capabilities, and supported platforms.
...
* Easy page navigation with:
    * [Thumbnail page view](https://help.syncfusion.com/document-processing/pdf/pdf-viewer/angular/navigation/page-thumbnail)
    * [Bookmark panel](https://help.syncfusion.com/document-processing/pdf/pdf-viewer/angular/navigation/bookmarks)
    * [Hyperlink navigation](https://help.syncfusion.com/document-processing/pdf/pdf-viewer/angular/navigation/hyperlink)
    * [Table of contents navigation](https://help.syncfusion.com/document-processing/pdf/pdf-viewer/angular/navigation/table-of-contents)
* Core interactions:
...
* [Globalization](https://help.syncfusion.com/document-processing/pdf/pdf-viewer/angular/globalization) - Localize the UI.
