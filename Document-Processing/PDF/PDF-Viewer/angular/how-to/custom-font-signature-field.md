---
Layout: post
title: To change the font family in Angular PDF Viewer component
description: Learn how to change the font family in Form Field's Type Signature in Angular PDF Viewer component of Syncfusion Essential JS 2 and more.
...
Change the font family in the type signature of the Angular PDF Viewer by adding a custom CSS stylesheet to the document and applying the desired font family to the type signature element. Include the Google Fonts link in the HTML head section to apply the font.
