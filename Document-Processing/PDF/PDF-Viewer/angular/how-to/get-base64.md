...
description: Learn here all about how to retrieve the Base64 value of a loaded PDF document in Angular PDF Viewer component of Syncfusion Essential JS 2 and more.
...
This guide shows how to obtain the Base64-encoded value of a PDF document loaded in the Angular PDF Viewer. Producing a Base64 string is useful for sending the PDF to a server, embedding it in JSON payloads, or client-side processing.
...
By implementing these steps in the Angular component, a PDF document loaded in the Angular PDF Viewer can be converted into a Base64-encoded data URL when a button is clicked. This facilitates the manipulation or transfer of PDF data as needed.
