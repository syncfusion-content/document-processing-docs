...
* Easy page navigation with:
    * [Thumbnail page view](./interactive-pdf-navigation/page-thumbnail-navigation)
    * [Bookmark panel](./interactive-pdf-navigation/bookmark-navigation)
    * [Hyperlink navigation](./interactive-pdf-navigation/hyperlink-navigation)
    * [Table of contents navigation](./interactive-pdf-navigation/table-of-content-navigation)
* Core interactions:
