...
![Calibrate Annotation in Blazor SfPdfViewer](../../../PDF-Viewer/blazor/images/blazor-pdfviewer-calibrate-annotation.png)
...
![Adding Calibrate in Blazor SfPdfViewer Toolbar](../../../PDF-Viewer/blazor/images/blazor-pdfviewer-add-calibrate-in-toolbar.png)
...
![Editing Calibrate FillColor in Blazor SfPdfViewer](../../../PDF-Viewer/blazor/images/blazor-pdfviewer-calibrate-fillcolor.png)

### Editing stroke color

The stroke color of the annotation can be edited using the color palette provided in the Edit Stroke Color tool.

![Editing Calibrate StrokeColor in Blazor SfPdfViewer](../../../PDF-Viewer/blazor/images/blazor-pdfviewer-calibrate-stroke-color.png)

### Editing thickness

The thickness of the border of the annotation can be edited using the range slider provided in the Edit thickness tool.

![Editing Calibrate Thickness in Blazor SfPdfViewer](../../../PDF-Viewer/blazor/images/blazor-pdfviewer-calibrate-thickness.png)

### Editing opacity

The opacity of the annotation can be edited using the range slider provided in the Edit Opacity tool.

![Editing Calibrate Opacity in Blazor SfPdfViewer](../../../PDF-Viewer/blazor/images/blazor-pdfviewer-calibrate-opacity.png)

### Editing the line properties

The properties of the line shapes such as distance and perimeter annotations can be edited using the Line properties window. It can be opened by selecting the Properties option in the context menu that appears on right-clicking the distance and perimeter annotations.

![Editing Calibrate Property in Blazor SfPdfViewer](../../../PDF-Viewer/blazor/images/blazor-pdfviewer-calibrate-property.png)
...
![Editing Calibrate Scale Ratio in Blazor SfPdfViewer](../../../PDF-Viewer/blazor/images/blazor-pdfviewer-calibrate-scaleratio.png)
...
![Calibrate Scale Dialog in Blazor SfPdfViewer](../../../PDF-Viewer/blazor/images/blazor-pdfviewer-calibrate-scale-dialog.png)
