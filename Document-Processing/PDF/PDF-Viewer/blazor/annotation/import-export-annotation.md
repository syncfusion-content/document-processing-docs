...
![Blazor SfPdfViewer with Edit Button](../../../PDF-Viewer-Classic/blazor/images/blazor-pdfviewer-edit-button.png)

* The annotation toolbar will appear.
* Click the Comment Panel button in the annotation toolbar.

![Blazor SfPdfViewer with Comment Panel](../../../PDF-Viewer-Classic/blazor/images/blazor-pdfviewer-edit-sticknotes-comment.png)

* The comments panel will be displayed.
* Click the **More Option** button in the comment panel container.

![Displaying More Option in Blazor SfPdfViewer](../../../PDF-Viewer-Classic/blazor/images/blazor-pdfviewer-show-more-option.png)
...
![Importing Annotation in Blazor SfPdfViewer](../../../PDF-Viewer-Classic/blazor/images/blazor-pdfviewer-import-annotation.png)

* Then the file explorer dialog will be opened. Choose the JSON file to be imported into the loaded PDF document.

![Blazor PDFViewer with Imported Annotation](../../../PDF-Viewer-Classic/blazor/images/blazor-pdfviewer-imported-annotation.png)
...
![Exporting Annotation in Blazor SfPdfViewer](../../../PDF-Viewer-Classic/blazor/images/blazor-pdfviewer-export-annotation.png)
