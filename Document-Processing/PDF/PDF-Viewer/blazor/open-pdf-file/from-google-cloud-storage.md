...
Start by following the steps provided in this [link](../../../PDF-Viewer-Classic/blazor/getting-started/server-side-application) to create a simple SfPdfViewer sample in blazor. This will give you a basic setup of the SfPdfViewer component.
