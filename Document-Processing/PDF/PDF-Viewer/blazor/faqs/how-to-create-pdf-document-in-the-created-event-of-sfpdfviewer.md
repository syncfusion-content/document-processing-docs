...
A PDF document can be created during the SfPdfViewer2 `Created` event and loaded in the viewer by converting it to a Base64 data URL and assigning it to `DocumentPath`.
