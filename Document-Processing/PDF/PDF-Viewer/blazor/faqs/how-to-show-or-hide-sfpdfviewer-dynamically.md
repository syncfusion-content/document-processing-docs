...
# Show or hide the SfPdfViewer2 component dynamically in Blazor
...
* [How to load Microsoft Office files in Blazor SfPdfViewer2 Component](./how-to-load-office-files) - Render Word, Excel, and PowerPoint files inside the PDF Viewer.
* [How to load PDF documents dynamically in Blazor SfPdfViewer2 Component](./how-to-load-pdf-document-dynamically) - Change the loaded PDF at runtime.
