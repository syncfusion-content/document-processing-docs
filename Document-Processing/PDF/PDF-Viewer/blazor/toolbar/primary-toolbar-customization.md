...
description: Learn how to customize the primary toolbar in the Syncfusion Blazor SfPdfViewer, including showing or hiding default items, rearranging items, and adding custom toolbar items.
