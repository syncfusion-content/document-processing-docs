...
For migrating from Vue 2 to Vue 3, refer to the [`migration`](https://help.syncfusion.com/document-processing/pdf/pdf-viewer/vue/getting-started-application) documentation.
