---
layout: post
title: Collaborative Editing in Vue PDF Viewer | Syncfusion
description: Learn how to configure real-time collaborative editing in the Syncfusion Vue PDF Viewer with the Syncfusion Collaborator packages.
...
# Collaborative Editing in Syncfusion Vue PDF Viewer

The Vue PDF Viewer supports real-time collaborative editing through the Syncfusion Collaborator framework. The framework uses a shared client package and a platform-specific Collaboration Server to synchronize PDF Viewer actions between users.
...
- **Collaboration Client** - The `@syncfusion/ej2-collaborator` package connects the Vue PDF Viewer to the Collaboration Server.
...
Install the shared client package in the Vue application:
