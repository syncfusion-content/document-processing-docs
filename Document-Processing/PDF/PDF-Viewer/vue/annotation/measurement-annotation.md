...
description: Learn about measurement annotations in the Vue PDF Viewer (Essential JS 2): distance, perimeter, area, radius, and volume.
control: PDF Viewer
...
![Opacity slider in the Edit Opacity tool](../images/calibrate_opacity.png)
