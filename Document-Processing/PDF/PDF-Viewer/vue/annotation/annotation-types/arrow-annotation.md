---
layout: post
title: Arrow Annotation (Shape) in Vue PDF Viewer | Syncfusion
description: Learn how to enable, apply, customize, and manage Arrow annotations in the Syncfusion Vue PDF Viewer.
...
# Arrow Annotation (Shape) in Vue PDF Viewer
...
{% highlight html tabtitle="App.vue" %}
<template>
  <button @click="enableArrowMode">Enable Arrow Mode</button>
...
{% highlight html tabtitle="App.vue" %}
<template>
  <button @click="exitArrowMode">Exit Arrow Mode</button>
  <ejs-pdfviewer ref="pdfviewer" id="container" :documentPath="documentPath" :resourceUrl="resourceUrl" style="height: 650px"></ejs-pdfviewer>
</template>
...
![Line properties dialog](../../images/calibrate_lineprop.png)
...
{% highlight html tabtitle="App.vue" %}
<template>
  <button @click="editArrowProgrammatically">Edit Arrow</button>
  <ejs-pdfviewer ref="pdfviewer" id="container" :documentPath="documentPath" :resourceUrl="resourceUrl" style="height: 650px"></ejs-pdfviewer>
</template>
...
{% highlight html tabtitle="App.vue" %}
<template>
  <button @click="addMultipleArrows">Add Multiple Arrows</button>
  <ejs-pdfviewer ref="pdfviewer" id="container" :documentPath="documentPath" :resourceUrl="resourceUrl" style="height: 650px"></ejs-pdfviewer>
</template>
