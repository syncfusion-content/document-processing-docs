---
layout: post
title: Line Annotation (Shape) in Vue PDF Viewer | Syncfusion
description: Learn how to enable, apply, customize, and manage Line annotations in the Syncfusion Vue PDF Viewer.
...
# Line Annotation (Shape) in Vue PDF Viewer
...
{% highlight html tabtitle="App.vue" %}
<template>
  <button @click="enableLineMode">Enable Line Mode</button>
...
{% highlight html tabtitle="App.vue" %}
<template>
  <button @click="exitLineMode">Exit Line Mode</button>
  <ejs-pdfviewer ref="pdfviewer" id="container" :documentPath="documentPath" :resourceUrl="resourceUrl" style="height: 650px"></ejs-pdfviewer>
</template>
...
{% highlight html tabtitle="App.vue" %}
<template>
  <button @click="editLineProgrammatically">Edit Line</button>
  <ejs-pdfviewer ref="pdfviewer" id="container" :documentPath="documentPath" :resourceUrl="resourceUrl" style="height: 650px"></ejs-pdfviewer>
</template>
...
{% highlight html tabtitle="App.vue" %}
<template>
  <button @click="addMultipleLines">Add Multiple Lines</button>
  <ejs-pdfviewer ref="pdfviewer" id="container" :documentPath="documentPath" :resourceUrl="resourceUrl" style="height: 650px"></ejs-pdfviewer>
</template>
