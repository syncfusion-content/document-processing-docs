---
layout: post
title: Rectangle Annotation (Shape) in Vue PDF Viewer | Syncfusion
description: Learn how to enable, apply, customize, and manage Rectangle annotations in the Syncfusion Vue PDF Viewer.
...
# Rectangle Annotation (Shape) in Vue PDF Viewer
...
![Shape toolbar](../../../javascript-es6/images/shape_toolbar.png)
...
{% highlight html tabtitle="App.vue" %}
<template>
  <button @click="enableRectangleMode">Enable Rectangle Mode</button>
...
{% highlight html tabtitle="App.vue" %}
<template>
  <button @click="exitRectangleMode">Exit Rectangle Mode</button>
  <ejs-pdfviewer ref="pdfviewer" id="container" :documentPath="documentPath" :resourceUrl="resourceUrl" style="height: 650px"></ejs-pdfviewer>
</template>
...
![Shape tools](../../../javascript-es6/images/shape_toolbar.png)
...
{% highlight html tabtitle="App.vue" %}
<template>
  <button @click="editRectangleProgrammatically">Edit Rectangle</button>
  <ejs-pdfviewer ref="pdfviewer" id="container" :documentPath="documentPath" :resourceUrl="resourceUrl" style="height: 650px"></ejs-pdfviewer>
</template>
...
{% highlight html tabtitle="App.vue" %}
<template>
  <button @click="addMultipleRectangles">Add Multiple Rectangles</button>
  <ejs-pdfviewer ref="pdfviewer" id="container" :documentPath="documentPath" :resourceUrl="resourceUrl" style="height: 650px"></ejs-pdfviewer>
</template>
