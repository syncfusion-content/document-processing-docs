...
Syncfusion<sup style="font-size:70%">&reg;</sup> packages are available at [npmjs.com](https://www.npmjs.com/package/@vue-pdf-viewer/viewer). To add the PDF Viewer to the project, install the `@syncfusion/ej2-vue-pdfviewer` package using one of the following commands:
