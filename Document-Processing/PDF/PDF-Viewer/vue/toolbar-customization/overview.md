...
description: Learn about the various toolbars available in the Syncfusion Vue PDF Viewer and how they help users access key PDF features.
control: PDF Viewer
...
This page provides a concise reference describing the toolbars available in the EJ2 Vue PDF Viewer component. It also explains what each toolbar is for and when it appears.
...
- [Add a custom primary toolbar item](./primary-toolbar#add-a-custom-primary-toolbar-item)
