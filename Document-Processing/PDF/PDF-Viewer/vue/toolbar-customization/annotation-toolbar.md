...
description: Learn how to customize the annotation toolbar in the Vue PDF Viewer component. Show/hide the toolbar and choose which tools to display and in what order.
