---
layout: post
title: Active Viewport Rendering | Syncfusion Vue PDF Viewer
description: Learn how Active Viewport Rendering optimizes large-document zooming in the Vue PDF Viewer.
...
# Active Viewport Rendering in Vue PDF Viewer

Active Viewport Rendering is a rendering optimization feature in the Vue PDF Viewer that improves zooming performance for large PDF pages.
...
- [Load Large PDF Files](./load-pdf-viewer-with-local-resources-vue)
- [Load N number of pages on initial loading](./load-n-number-page)
- [How to Overview of the Vue PDF Viewer](../how-to-overview)
