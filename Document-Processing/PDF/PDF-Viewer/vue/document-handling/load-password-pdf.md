---
layout: post
title: Load Password Protected PDFs in Vue PDF Viewer | Syncfusion
description: Learn how to open password-protected PDF files in the Syncfusion Vue PDF Viewer by providing the password in the documentPath object.
control: PDF Viewer
...
You can directly pass the password in the [`load`](https://ej2.syncfusion.com/vue/documentation/api/pdfviewer/index-default#load) method:
...
If the [`documentPath`](https://ej2.syncfusion.com/vue/documentation/api/pdfviewer/index-default#documentpath) points to a password-protected PDF:
