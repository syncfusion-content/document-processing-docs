...
{% highlight cshtml tabtitle="Standalone" %}
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            ...
            // disable the Form Designer option
...
{% highlight cshtml tabtitle="Standalone" %}
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            var pdfviewer = document.getElementById('pdfviewer').ej2_instances[0];
            pdfviewer.enableFormDesigner = false; // disable form designer option
        });
    </script>
...
{% highlight cshtml tabtitle="Standalone" %}
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            var pdfviewer = document.getElementById('pdfviewer').ej2_instances[0];
            document.getElementById('showDesignerBtn').onclick = function () { pdfviewer.isFormDesignerToolbarVisible = true; };
            document.getElementById('hideDesignerBtn').onclick = function () { pdfviewer.isFormDesignerToolbarVisible = false; };
        });
    </script>
