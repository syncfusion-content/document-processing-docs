---
layout: post
title: Active Viewport Rendering | Syncfusion ASP.NET MVC PDF Viewer
description: Learn how Active Viewport Rendering optimizes large-document zooming in the ASP.NET MVC PDF Viewer.
...
# Active Viewport Rendering in ASP.NET MVC PDF Viewer

Active Viewport Rendering is a rendering optimization feature in the ASP.NET MVC PDF Viewer that improves zooming performance for large PDF pages.
...
- [Load N number of pages on initial loading](./load-n-number-page)
- [Use local resources to configure PDF Viewer](./local-resources)
- [How to Overview of the ASP.NET MVC PDF Viewer](../how-to-overview)
