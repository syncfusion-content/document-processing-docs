...
# Ink Eraser in ASP.NET MVC PDF Viewer
...
To enable the Ink Eraser feature, include the Toolbar and Annotation in your ASP.NET MVC PDF Viewer:

- [**Annotation**](https://ej2.syncfusion.com/aspnetmvc/documentation/pdfviewer/index-default#annotation)
- [**Toolbar**](https://ej2.syncfusion.com/aspnetmvc/documentation/pdfviewer/index-default#toolbar)
...
> **Note:** In ASP.NET MVC, the required modules are loaded automatically when the PDF Viewer is initialized. No additional module injection is needed.

## UI-based erasing

The Ink Eraser is accessible through the annotation toolbar in the ASP.NET MVC PDF Viewer.
...
> **Note**: The eraser only removes ink strokes; it does not affect other annotation types like highlights, text boxes, or shapes.
...
<button onclick="enableEraser()">Enable Eraser</button>
<button onclick="disableEraser()" style="margin-left: 10px;">Disable Eraser</button>
<div style="width:100%;height:650px">
    @Html.EJS().PdfViewer("pdfviewer")
        .DocumentPath("https://cdn.syncfusion.com/content/pdf/pdf-succinctly.pdf")
        .Render()
...
<script>
    function enableEraser() {
        ...
        pdfViewer.enableInkEraser = true;
    }

    function disableEraser() {
        var pdfViewer = document.getElementById('pdfviewer').ej2_instances[0];
        pdfViewer.enableInkEraser = false;
    }
</script>
...
<button onclick="setEraserSize(10)">Small (10px)</button>
<button onclick="setEraserSize(15)" style="margin-left: 10px;">Medium (15px)</button>
<button onclick="setEraserSize(20)" style="margin-left: 10px;">Large (20px)</button>
<div style="width:100%;height:650px">
    @Html.EJS().PdfViewer("pdfviewer")
        .DocumentPath("https://cdn.syncfusion.com/content/pdf/pdf-succinctly.pdf")
        .Render()
...
<button onclick="applyRoleBasedEraserSettings()">Apply Role-Based Settings</button>
<div style="width:100%;height:650px">
    @Html.EJS().PdfViewer("pdfviewer")
        .DocumentPath("https://cdn.syncfusion.com/content/pdf/pdf-succinctly.pdf")
        .Render()
...
<script>
    var userRole = 'editor'; // This would typically come from your authentication system
...
<div style="margin-bottom: 10px;">
    <button onclick="switchToDrawing()" id="drawBtn" style="background-color: #007bff; color: white; cursor: pointer; padding: 8px 16px; margin-right: 10px;">
        Draw Mode
    </button>
    <button onclick="switchToEraser()" id="eraseBtn" style="background-color: #e9ecef; color: black; cursor: pointer; padding: 8px 16px;">
        Erase Mode
    </button>
</div>
<div style="width:100%;height:650px">
...
<script>
    ...
    function updateButtonStyles() {
        ...
        if (currentMode === 'draw') {
            ...
            eraseBtn.style.backgroundColor = '#e9ecef';
            eraseBtn.style.color = 'black';
        } else {
            drawBtn.style.backgroundColor = '#e9ecef';
            drawBtn.style.color = 'black';
            eraseBtn.style.backgroundColor = '#dc3545';
