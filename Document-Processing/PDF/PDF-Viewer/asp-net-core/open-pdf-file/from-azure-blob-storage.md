---
layout: post
title: From Azure Blob Storage in ASP.NET Core PDF Viewer | Syncfusion
description: Load and display PDF files stored in Azure Blob Storage in the ASP.NET Core PDF Viewer using a server-backed web service for secure access.
platform: document-processing
control: PDF Viewer
documentation: ug
---

# Open PDF from Azure Blob Storage in ASP.NET Core PDF Viewer
