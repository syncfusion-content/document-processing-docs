...
# Redaction in Mobile View in ASP.NET Core PdfViewer Component
...
To enable redaction functionality in your ASP.NET Core application, configure the PDF Viewer with the following setup:
