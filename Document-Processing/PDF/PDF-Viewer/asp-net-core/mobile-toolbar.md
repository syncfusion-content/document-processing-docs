...
description: Learn about the mobile toolbar interface in the ASP.NET Core PDF Viewer, including main options, more menu actions, and enabling desktop mode on mobile.
