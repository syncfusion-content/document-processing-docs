...
description: Learn how to open the thumbnail pane programmatically in the ASP.NET Core PDF Viewer by calling the openThumbnailPane method after the document loads.
