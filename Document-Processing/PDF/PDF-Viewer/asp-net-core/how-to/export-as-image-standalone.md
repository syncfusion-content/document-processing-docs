---
layout: post
title: Export PDF pages as images in ASP.NET Core PDF Viewer
description: Learn how to export PDF pages as Base64-encoded images by using the ASP.NET Core PDF Viewer component.
