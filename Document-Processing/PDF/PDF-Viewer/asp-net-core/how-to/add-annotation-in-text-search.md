...
description: Learn to add rectangle annotations using text search bounds in the ASP.NET Core PDF Viewer component, including initialization and search controls.
