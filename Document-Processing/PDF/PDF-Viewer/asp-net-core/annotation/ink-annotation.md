...
description: Learn about ink annotations in the ASP.NET Core PDF Viewer (Essential JS 2): add, edit, delete, and default settings.
control: PDF Viewer
...
<div style="width:100%;height:640px">
    <ejs-pdfviewer id="pdfviewer" style="height:640px" documentPath="https://cdn.syncfusion.com/content/pdf/pdf-succinctly.pdf">
    </ejs-pdfviewer>
</div>
<script>
    function inkMode() {
...
<script>
    window.onload = function() {
        var viewer = document.getElementById('pdfviewer').ej2_instances[0];
        if (viewer) {
            viewer.inkAnnotationSettings = { author: 'Syncfusion', strokeColor: 'green', thickness: 3, opacity: 0.6 };
        }
    };
</script>
