...
description: Learn how to flatten annotations and form fields before saving a PDF in the Syncfusion ASP.NET Core PDF Viewer.
...
<div style="width:100%;height:680px">
  <div style="margin-bottom: 8px;">
    <button onclick="flattenPdf()">Download PDF (flatten)</button>
  </div>
