---
layout: post
title: Handwritten signature in ASP.NET Core PDF Viewer control | Syncfusion
description: Learn about handwritten signatures in the Syncfusion ASP.NET Core PDF Viewer (Essential JS 2): add, enable/disable, and edit properties.
control: PDF Viewer
...
<div>
    <button type="button" id="SignatureMode" onclick="handWrittenSignature()">HandWritten Signature mode</button>
    <div class="control-section" style="height:640px">
...
function addAnnotation() {
    ...
    // 1) Handwritten Signature – Draw mode
    ...
    // 2) Handwritten Signature – Text mode
    viewer.annotation.addAnnotation("HandWrittenSignature", {
        offset: { x: 200, y: 310 },
        pageNumber: 1,
        width: 200,
...
<div>
    <div style="margin-bottom: 12px; display: flex; gap: 8px;">
        <button type="button" id="addSignatureBtn" onclick="addSignature()">Add Signature Annotation</button>
        <button type="button" id="editSignatureBtn" onclick="editSignature()">Edit Signature Annotation</button>
    </div>

    <div class="control-section" style="height:650px">
        <ejs-pdfviewer id="container"
...
function editSignature() {
    ...
    for (var i = 0; i < viewer.signatureCollection.length; i++) {
