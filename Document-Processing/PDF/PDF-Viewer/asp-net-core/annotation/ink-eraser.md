...
# Ink Eraser in ASP.NET Core PDF Viewer
...
> **Note:** In ASP.NET Core, the required modules are loaded automatically when the PDF Viewer is initialized. No additional module injection is needed.

## UI-based erasing

The Ink Eraser is accessible through the annotation toolbar in the ASP.NET Core PDF Viewer.
