...
description: Enable, apply, customize, and manage Stamp annotations in the ASP.NET Core PDF Viewer, including dynamic, sign-here, standard business, and custom stamps.
...
{% highlight cshtml tabtitle="Standalone" %}
<script>
function addTextStampProgrammatically() {
  var viewer = document.getElementById('pdfviewer').ej2_instances[0];
  viewer.annotation.addAnnotation('Stamp', {
    offset: { x: 100, y: 200 },
    pageNumber: 1,
...
{% highlight cshtml tabtitle="Standalone" %}
<script>
function addImageStampProgrammatically() {
  var viewer = document.getElementById('pdfviewer').ej2_instances[0];
  viewer.annotation.addAnnotation('Stamp', {
    offset: { x: 100, y: 300 },
    pageNumber: 1,
