...
# Load Large PDF Files in ASP.NET Core PDF Viewer

This article explains how to efficiently load and view large PDF files using the Syncfusion ASP.NET Core PDF Viewer. It includes recommended best practices and performance tips for documents ranging from **50 MB to 2 GB**.
...
The **Syncfusion ASP.NET Core PDF Viewer is fully optimized for these heavy workloads**, and it delivers excellent performance even when working with very large files.
...
Modules:
- [`Text Search`](https://help.syncfusion.com/document-processing/pdf/pdf-viewer/asp-net-core/text-search)
- [`Text Selection`](https://help.syncfusion.com/document-processing/pdf/pdf-viewer/asp-net-core/textselection)
...
Modules:
- [`Organize Pages`](https://help.syncfusion.com/document-processing/pdf/pdf-viewer/asp-net-core/organize-pdf)
- [`Thumbnail View`](https://help.syncfusion.com/document-processing/pdf/pdf-viewer/asp-net-core/interactive-pdf-navigation/page-thumbnail)
...
- [Load PDF (GitHub Sample)](https://github.com/SyncfusionExamples/asp-core-pdf-viewer-examples/tree/master)