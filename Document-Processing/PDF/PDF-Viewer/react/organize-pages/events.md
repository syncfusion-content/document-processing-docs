...
description: Subscribe to Organize Pages events in the React PDF Viewer to react to rotate, rearrange, insert, delete, and copy actions on pages.
...
# Organize Pages Events in React PDF Viewer
