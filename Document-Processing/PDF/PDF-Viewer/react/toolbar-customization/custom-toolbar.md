...
description: Learn how to create and customize a toolbar in the Syncfusion React PDF Viewer, including adding commands and modifying built-in tools.
control: PDF Viewer
...
import {
    PdfViewerComponent, Toolbar, Magnification, Navigation, LinkAnnotation, BookmarkView, ThumbnailView, Print, TextSelection, TextSearch, Inject
...
import './index.css';
import {
    PdfViewerComponent, Magnification, Navigation, LinkAnnotation, BookmarkView, ThumbnailView, Print, TextSelection, TextSearch, Inject
} from '@syncfusion/ej2-react-pdfviewer';
