---
layout: post
title: Sticky notes annotation in React PDF Viewer | Syncfusion
description: Learn to add, edit, delete, and customize Sticky Notes annotations in Syncfusion React PDF Viewer, with UI and programmatic examples.
