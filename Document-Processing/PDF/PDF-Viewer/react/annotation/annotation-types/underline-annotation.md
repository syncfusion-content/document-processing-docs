...
description: Learn to add, edit, delete, and customize Underline text markup annotations in Syncfusion React PDF Viewer, with UI and programmatic examples.
...
# Underline annotation in React PDF Viewer
