---
layout: post
title: Find Text in React PDF Viewer | Syncfusion
description: Configure text search in the React PDF Viewer and run programmatic searches to find and highlight matching text inside a PDF document.
