---
layout: post
title: Open PDF files from One Drive in React Pdfviewer component | Syncfusion
description: Learn about how to load PDF files from One Drive in Syncfusion React Pdfviewer component of Syncfusion Essential JS 2 and more.
