...
description: Learn about the various navigation options available in the Syncfusion React PDF Viewer control.
...
|----------------|-------------|
| [Page Navigation](./page) | Navigate between pages using toolbar buttons or programmatic APIs |
| [Bookmark Navigation](./bookmark) | Navigate using document bookmarks |
| [Hyperlink Navigation](./hyperlink) | Handle internal and external hyperlinks |
| [Page Thumbnail Navigation](./page-thumbnail) | Navigate using thumbnail previews of pages |
...
- Retrieve bookmark list using `getBookmarks`
