...
Step 8: Register your service in the ``Program.cs`` class as follows.
...
Step 11: Add the following JavaScript function in the ``App.razor`` file available under the ``Components`` folder.
