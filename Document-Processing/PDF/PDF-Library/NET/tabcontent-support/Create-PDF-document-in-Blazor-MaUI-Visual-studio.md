...
Step 2: In the **Interactive Render Mode section**, choose `Server` as the render mode. Then, click the `Create` button to generate a .NET MAUI Blazor Hybrid and Web App.
![Blazor client configuration window](Create-PDF-Blazor/Maui-server-app.png)
