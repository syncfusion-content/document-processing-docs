...
Essential&reg; PDF provides support to insert, remove and modify the bookmarks in the PDF Document.
...
When loading an existing document, the Essential&reg; PDF loads all bookmarks of the document.  
...
Essential&reg; PDF allows you to modify the bookmarks in the existing PDF document. The following modifications can be done to bookmarks in an existing document. 
