---
title: Create PDF document on macOS | Syncfusion
description: Create PDF document in a .NET console application on macOS using Syncfusion .NET Core PDF library without the dependency of Adobe Acrobat.
