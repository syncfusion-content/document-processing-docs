...
Brushes are used to draw the content on PDF document with specific color and style. Various brushes available in Syncfusion Essential&reg; PDF are,
...
The solid brush is used to fill an object with solid color. Essential&reg; PDF supports drawing shapes on PDF document with solid brush using the [PdfSolidBrush](https://help.syncfusion.com/cr/document-processing/Syncfusion.Pdf.Graphics.PdfSolidBrush.html) class. The following code snippet illustrates this.
...
The gradient brush is used to fill an object with blend of two or more colors. Essential&reg; PDF supports drawing shapes on PDF document with linear gradient brush using [PdfLinearGradientBrush](https://help.syncfusion.com/cr/document-processing/Syncfusion.Pdf.Graphics.PdfLinearGradientBrush.html) class. The following code snippet illustrates this.
