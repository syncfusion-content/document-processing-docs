...
2. 	The Syncfusion&reg; PDF Web Installer's welcome wizard will be displayed. Click the Next button.
...
Syncfusion&reg; PDF installer can be uninstalled in two ways.

   * Uninstall the PDF using the Syncfusion&reg; PDF web installer
   * Uninstall the PDF from Windows Control Panel

Follow either one of the option below to uninstall Syncfusion&reg; Essential Studio&reg; PDF installer.
  
**Option 1: Uninstall the PDF using the Syncfusion&reg; PDF web installer**
...
You can uninstall all the installed products by selecting the **Syncfusion Essential Studio&reg; {version}** entry (element 1 in the below screenshot) from the Windows control panel, or you can uninstall PDF alone by selecting the **Syncfusion Essential Studio&reg; for PDF {version}** entry (element 2 in the below screenshot) from the Windows control panel.

![Control Panel](images/Step-by-Step-Installation_img22.png)
	
N> If the **Syncfusion Essential Studio&reg; for PDF {version}** entry is selected from the Windows control panel, the Syncfusion Essential Studio&reg; PDF alone will be removed and the below default MSI uninstallation window will be displayed.	

1.  The Syncfusion&reg; PDF Web Installer's welcome wizard will be displayed. Click the Next button
