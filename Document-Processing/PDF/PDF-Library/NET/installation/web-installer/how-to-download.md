...
6. Click the Download (element 1 in the screenshot below) button to get the Syncfusion Essential Studio<sup>&reg;</sup> PDF web installer.
...
8. After downloading, the Syncfusion<sup>&reg;</sup> PDF web installer can be unlocked using Syncfusion<sup>&reg;</sup> registered login credential.
