...
<td> 
Merge(PdfDocumentBase, Stream[]) <br/> Sample link: {{'[Merge multiple PDFs from streams example](https://github.com/SyncfusionExamples/PDF-Examples/tree/master/Merge%20PDFs/Merge-multiple-documents-from-stream/)'| markdownify }}
</td>
</tr>
<tr>
<td>
...
<td> 
Merge(PdfDocumentBase, Stream[]) <br/> Sample link: {{'[Merge multiple PDFs from streams](https://github.com/SyncfusionExamples/PDF-Examples/tree/master/Merge%20PDFs/Merge-multiple-documents-from-stream/)'| markdownify }}
</td>
</tr>
<tr>
<td>
...
<td> 
RemoveImage(PdfImageInfo[]) <br/> Sample link: {{'[Remove images from PDF](https://github.com/SyncfusionExamples/PDF-Examples/tree/master/Images/Remove-images-from-PDF-document)'| markdownify }}
</td>
</tr>
<tr>
<td>
