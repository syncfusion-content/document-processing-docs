...
The [PdfDocument](https://ej2.syncfusion.com/documentation/api/pdf/pdfdocument) constructor can accept PDF data in either Base64 string or Uint8Array format. Here's a quick example for both approaches:
