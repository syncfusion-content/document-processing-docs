...
@Component({
  ...
  template: `<ejs-spreadsheet #spreadsheet [openUrl]="openUrl" [saveUrl]="saveUrl" (created)="created()" [showCommentsPane]="true">
                 <e-sheets>
...
export class AppComponent {
  ...
  created() {
    ...
    // Add comment using updateCell method.
