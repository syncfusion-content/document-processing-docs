...
standalone: true,
  ...
  template:
    "<ejs-spreadsheet #spreadsheet openUrl='https://document.syncfusion.com/web-services/spreadsheet-editor/api/spreadsheet/open' allowOpen='true' (openComplete)='openComplete($event)'> </ejs-spreadsheet>",
})
