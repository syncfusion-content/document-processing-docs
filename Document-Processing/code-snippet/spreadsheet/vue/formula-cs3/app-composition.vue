...
const created = function () {
  spreadsheet.value.cellFormat({ textAlign: 'center', fontWeight: 'bold' }, 'A1:E1');
  spreadsheet.value.numberFormat(getFormatFromType('Currency'), 'D2:E12');
  spreadsheet.value.numberFormat(getFormatFromType('Currency'), 'E13:E15');
}
</script>
<style>
